...
function agregaRegistrolab(){
	var url = '../php/far_agrega_proveedor.php';
	$.ajax({
		type:'POST',
		url:url,
...
function eliminaLab(id){
	var url = '../php/far_eliminaProvee.php';
...
function editarLab(id){
	$('#formulario')[0].reset();
	var url = '../php/far_editaProvee.php';
		$.ajax({
		type:'POST',
		url:url,
		data:'id='+id,
...
function pagination(partida){
	var url = '../php/far_paginarProveedor.php';
	$.ajax({
		type:'POST',
		url:url,
