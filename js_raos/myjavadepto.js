...
function agregaRegistro(){
	var url = '../php/z_agrega_depto.php';
	$.ajax({
		type:'POST',
		url:url,
		...
		success: function(registro){
			...
			$(location).attr('href','z_departamentos.php');
			return false;
			}else{
...
function eliminarActivo(id){
	var url = '../php/z_elimina_depto.php';
	var pregunta = confirm('¿Esta seguro de eliminar a esta Departamento?');
	if(pregunta==true){
		$.ajax({
		type:'POST',
		url:url,
...
function pagination(partida){
	var url = '../php/z_paginardepto.php';
	$.ajax({
		type:'POST',
		url:url,
