...
$("#mtt").val(res);
	...
	$(".guardar-vendedor").off("click");
	$(".guardar-vendedor").on("click", function(e) {
		var respo = $('#respo').val();
		var idusu = $('#idusu').val();
		...
		$.ajax({
			url: '../Controller/ControladorVentas.php?page=9',
			type: 'post',
			data: {'idusu':idusu,'respo':respo,'fechav':fechav,'cven':cven},
			dataType: 'json',
			success: function(data) {
