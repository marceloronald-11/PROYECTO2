...
function agregaRegistrocla(){
	var url = '../php/moises_agrega_grupo.php';
	$.ajax({
		type:'POST',
		url:url,
...
function eliminaCla(id){
	var url = '../php/moises_eliminaGru.php';
...
function editarCla(id){
	$('#formulario')[0].reset();
	var url = '../php/moises_editaGru.php';
		$.ajax({
		type:'POST',
		url:url,
		data:'id='+id,
...
function pagination(partida){
	var url = '../php/moises_paginarGrupo.php';
	$.ajax({
		type:'POST',
		url:url,
