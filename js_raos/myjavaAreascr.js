...
function agregaRegistroAreas(){
	var url = '../php/crm_agrega_Area.php';
	$.ajax({
		type:'POST',
		url:url,
...
function eliminaAr(id){
	var url = '../php/crm_eliminaAr.php';
...
function pagination(partida){
	var url = '../php/crm_paginar_areas.php';
	$.ajax({
		type:'POST',
		url:url,
