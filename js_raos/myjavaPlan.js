...
function agregaRegistroPlan(){
	var url = '../php/crm_agrega_Plan.php';
	$.ajax({
		type:'POST',
		url:url,
...
function eliminaPlan(id){
	var url = '../php/crm_PlanElimina.php';
...
function VerPlanPagos(id,codclix){ //codsoli, codcli
	var url = '../php/crm_plandepagos.php';
...
function pagination(partida){
	var url = '../php/crm_paginarPlan.php';
	$.ajax({
		type:'POST',
		url:url,
