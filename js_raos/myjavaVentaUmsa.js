...
//		}
		...
		$.ajax({
			url: '../Controller/ProductoControllerActivo.php?page=33',
			type: 'post',
...
window.open('../php/a_pdf_boletaing.php?norden='+norden, "_blank", "toolbar=yes,scrollbars=yes,resizable=yes,top=70,left=500,width=500,height=600");
location.reload();
