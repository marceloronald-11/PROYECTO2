...
$(function(){
	...
	$('#bs-prod').on('change',function(){
		...
		var url = '../php/crm_busca_doc2.php';
		$.ajax({
		type:'POST',
		url:url,
		data:'dato='+dato,
...
function eliminaCli(id){
	var url = '../php/crm_eliminaDocc.php';
...
function eliminaDocumento(coddocx,codalumx){ //codaa   codalum codarea
	var url = '../php/crm_eliminadoc2.php';
	var pregunta = confirm('¿Esta seguro de eliminar este Registro ?');
	if(pregunta==true){
		$.ajax({
		type:'POST',
		url:url,
		//data:'id='+id,
		data:'id='+coddocx+'&codal='+codalumx,			
		success: function(registro){
			$('#agrega-registros').html(registro);
			return false;
		}
...
function VerAreas(id){
	var url = '../php/crm_verDocumentos.php';
	//var pregunta = confirm('¿Esta seguro de eliminar este Registro ?');
	//if(pregunta==true){
		$.ajax({
		type:'POST',
...
function VerDocumentoss(codclix){
	var url = '../php/crm_verDatoss.php';
	//var pregunta = confirm('¿Esta seguro de eliminar este Registro ?');
	//if(pregunta==true){
		$.ajax({
		type:'POST',
...
function SubirDoc3(codclix){ //codtra
	
	var url = 'crm_verdocc.php';
	var pregunta =true;
	if(pregunta==true){
	$('#modalfotodoc').modal({
					show:true,
...
function pagination(partida){
	var url = '../php/crm_paginarParticipadoc.php';
	$.ajax({
		type:'POST',
		url:url,
