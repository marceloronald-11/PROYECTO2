...
function agregaRegistroCargo(){
	var url = '../php/crm_agrega_Cargo.php';
	$.ajax({
		type:'POST',
		url:url,
...
function eliminaCar(id){
	var url = '../php/crm_eliminaCar.php';
...
function editarCar(id){
	$('#formulario')[0].reset();
	var url = '../php/crm_editaCargo.php';
		$.ajax({
		type:'POST',
		url:url,
		data:'id='+id,
...
function pagination(partida){
	var url = '../php/crm_paginar_cargo.php';
	$.ajax({
		type:'POST',
		url:url,
