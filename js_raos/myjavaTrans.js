...
$(function(){
	...
	$('#nuevo-transpo').on('click',function(){
		$('#formulario')[0].reset();
		$('#pro').val('Registro');
		$('#edi').hide();
		$('#reg').show();
...
function agregaRegistroTran(){
	var url = '../php/aa_agrega_Trans.php';
	$.ajax({
		type:'POST',
		url:url,
...
function ImprimeTra(codtrax){
	window.open('../php/aa_notaTrans.php?codtrax='+codtrax);
}
...
function pagination(partida){
	...
	var url = '../php/aa_paginaTraspor.php';
