...
$(function(){
	...
	$('#bs-prod').on('keyup',function(){
		...
		var url = '../php/busca_proveedor.php';
		$.ajax({
		type:'POST',
		url:url,
		data:'dato='+dato,
...
function eliminarProducto(id){
	var url = '../php/elimina_proveedor.php';
...
function editarProducto(id){
	$('#formulario')[0].reset();
	var url = '../php/edita_proveedor.php';
		$.ajax({
		type:'POST',
		url:url,
		data:'id='+id,
...
function reportePDF(){
	var desde = $('#bd-desde').val();
	var hasta = $('#bd-hasta').val();
	window.open('../php/prod_pdf4.php?desde='+desde+'&hasta='+hasta);
}

function pagination(partida){
	var url = '../php/paginarProveedor.php';
	$.ajax({
		type:'POST',
		url:url,
