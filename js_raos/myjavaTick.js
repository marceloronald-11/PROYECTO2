...
//								$( "#cant" ).focus();
	...
	$(".btn-agregar-ticket").off("click");
	$(".btn-agregar-ticket").on("click", function(e) {
		var idcod2 = $("#idcodx").val();
		var coservi2 = $("#cdarea").val();
		var obv2 = $("#obvtk").val();
		...
		if(idcod2!=0){
			...
			//if(cantidad<100000){
				$.ajax({
					url: '../Controller/Controlador2021.php?page=2',
					type: 'post',
					data: {'idcod':idcod2, 'coservi':coservi2, 'obv':obv2},
					dataType: 'json',
...
//							$("#desart" ).focus();
							...
							$(".listaservicios").load('../php/crm_detalle_tk.php');
							//location.reload();
			...
			alertify.error('Datos Invalidos revise !!!');
		}
	});
