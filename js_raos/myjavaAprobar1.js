...
function agregaRegistroApro(){
	//var pregunta = confirm('¿Esta seguro de eliminar este Registrohhhh ?');
	var url = '../php/crm_agrega_Aprobado2.php';
	$.ajax({
		type:'POST',
		url:url,
...
function eliminaSer(id){
	var url = '../php/crm_eliminaSer2.php';
...
function editarCli(id){
	$('#formulario')[0].reset();
	var url = '../php/crm_editaClie2.php';
		$.ajax({
		type:'POST',
		url:url,
		data:'id='+id,
...
function pagination(partida){
	var url = '../php/crm_paginar_aprobar1.php';
	$.ajax({
		type:'POST',
		url:url,
