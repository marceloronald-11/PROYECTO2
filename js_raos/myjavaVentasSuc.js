				...
				$.ajax({
					...
					success: function(data) {
						if(data.success==true){
							...
							alertify.success(data.msj);
							$(".detalle-producto").load('../php/aa_detalle_ventassuc.php');
...
//		}
		$.ajax({
			url: '../Controller/ControladorVentass2.php?page=3',
			type: 'post',
			data: {'idusu':idusu,'respo':respo,'fechav':fechav,'codclix':codclix,'tpgx':tpagx},
			dataType: 'json',
			success: function(data) {
...
window.open('../php/aa_pdf_boletaing2.php?norden='+norden, "_blank", "toolbar=yes,scrollbars=yes,resizable=yes,top=70,left=500,width=700,height=600");
