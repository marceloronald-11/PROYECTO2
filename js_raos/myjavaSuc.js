...
function agregaRegistroSuc(){ // sisadal
	var url = '../php/aa_agrega_Suc.php';
	$.ajax({
		type:'POST',
		url:url,
...
function eliminarSuc(id){ //SISADAL
	var url = '../php/aa_elimina_Suc.php';
