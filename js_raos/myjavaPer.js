...
function agregaRegistroPee(){ // sisadal
	var url = '../php/aa_agrega_Pee.php';
	$.ajax({
		type:'POST',
		url:url,
...
function editarPee(id){ /// sisadal
//var pregunta = confirm('¿Esta seguro de eliminar este ACAAA !!!!!!');
	$('#formulario')[0].reset();
	var url = '../php/aa_edita_pee.php';
		$.ajax({
		type:'POST',
		url:url,
		data:'id='+id,
...
function eliminarPee(id){ //SISADAL
	var url = '../php/aa_elimina_Pee.php';
