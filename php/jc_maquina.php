...
-->
		...
		<!-- java personal -->
        <script src="../js_raos/myjavaMaq.js"></script>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title" id="myModalLabel"><b>MAQUINAS</b></h4>
            </div>
            <form id="formulario" class="form-horizontal " onsubmit="return agregaRegistroMqq();">
            <div class="modal-body">
					 <input type="hidden"   id="idmak" name="idmak" />
...
<div class="row">
   <div class="col-md-8">
	...
	<input type="text" readonly class="form-control input-sm" id="codmaqi" name="codmaqi" placeholder="Codigo" />
	</div>
</div>
...
<div class="row">
   <div class="col-md-12">
	...
	<input type="text" class="form-control input-sm" id="nommaq" name="nommaq" required placeholder="Detalle" />
	</div>
</div>
