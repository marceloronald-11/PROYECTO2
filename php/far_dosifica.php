...
-->
		...
		<!-- java personal -->
        <script src="../js_raos/myjavaDosifica.js"></script>
...
-->            			<option value="operador">Sucursal</option>
...
-->					</select>
				...
				<div class = "form-group">
      			<label for = "csuc" class="control-label col-xs-3 titi">SUCURSAL :</label>
                <div class="col-xs-7" >
					<select name="csuc" id="csuc" class="form-control" >
                    <option value="0">Ninguno</option>
						<?php foreach($sucur as $su):?>
