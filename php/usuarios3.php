...
<input type="hidden" class="form-control" id="pro" name="pro" readonly>
...
<div class = "form-group">
<label for = "usu" class="control-label col-xs-3 titi">Departamento:</label>
 <div class="col-xs-7">
<select name="dpp" id="dpp" class="form-control" >
 <option value="0">Ninguno</option>
	<?php foreach($depto as $dp):?>
<option value="<?php echo $dp['coddep']?>"><?php echo $dp['descripdepto']?></option>
	<?php endforeach;?>
	</select>
</div>
</div>
				...
				<div class="form-group">
                    ...
                    <div class="col-xs-7">
        					<select required="required" name="tipo" id="tipo" class="form-control">
