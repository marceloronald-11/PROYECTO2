...
-->
		...
		<!-- java personal -->
        <script src="../js_raos/myjavaCoaProductos2.js"></script>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
					...
					<input type="hidden" value="0"   id="neto" name="neto" >
					<input type="hidden" id="dime" name="dime">
				
					<input type="hidden" id="prov" name="prov" value="0">
					<input type="hidden" id="umed" name="umed" value="Und.">
					<input type="hidden" id="seriex" name="seriex" value="0">
					<input type="hidden" id="stomi" name="stomi" value="0">
...
-->			   
  				...
  				<div class="form-group">
        			<label class="control-label col-xs-3 titi" for="coddi">Codigo:</label>
                    <div class="col-xs-4">
        			<input type="text" value="0" class="form-control" id="coddi" name="coddi" required placeholder="Codigo">
                    </div>
    			</div>	
  				<div class="form-group">
        			<label class="control-label col-xs-3 titi" for="pvp">Costo:</label>
                    <div class="col-xs-4">
        			<input type="text" value="0" class="form-control" id="pvp" name="pvp" required placeholder="Precio Venta">
                    </div>
    			</div>	
				<div class="form-group">
        			<label class="control-label col-xs-3 titi" for="marcax">Marca:</label>
                    <div class="col-xs-4">
        			<input type="text"  class="form-control" id="marcax" name="marcax" required placeholder="Marca">
                    </div>
    			</div>
				<div class="form-group">
        			<label class="control-label col-xs-3 titi" for="modelox">Modelo:</label>
                    <div class="col-xs-6">
        			<input type="text"  class="form-control" id="modelox" name="modelox" required placeholder="Modelo">
                    </div>
    			</div>					
<!--				<div class="form-group">
        			<label class="control-label col-xs-3 titi" for="seriex">Serie:</label>
                    <div class="col-xs-6">
        			<input type="text"  class="form-control" id="seriex" name="seriex" required placeholder="Serie">
                    </div>
    			</div>					
-->				<div class="form-group">
        			<label class="control-label col-xs-3 titi" for="procex">Procedencia:</label>
                    <div class="col-xs-6">
        			<input type="text"  class="form-control" id="procex" name="procex" required placeholder="Procedencia">
                    </div>
    			</div>					
