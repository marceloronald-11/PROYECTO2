...
-->
		...
		<!-- java personal -->
        <script src="../js_raos/myjavaReportecli.js"></script>
	...
	<ul class="nav nav-list">
					...
					<li class="">
						...
						<ul class="submenu">
							...
							<!-- <li class="">
								<a href="jc_entregaCompra22.php">
									<i class="menu-icon fa fa-caret-right"></i>
									NOTA DE ENTREGA MANTENIMIENTO
								</a>
								<b class="arrow"></b>
							</li>  -->
						</ul>
