<?php
    ...
    $nroProductos = mysqli_num_rows(mysqli_query($conexion,"SELECT * FROM articulos AS ar LEFT JOIN clasificacion AS cl ON ar.codcla=cl.codcla LEFT JOIN proveedor AS pvv ON ar.codpv=pvv.codpv  "));
    $nroLotes = 10;
    ...
    if($paginaActual < $nroPaginas){
  	...
  	$registro = mysqli_query($conexion,"SELECT * FROM articulos AS ar LEFT JOIN clasificacion AS cl ON ar.codcla=cl.codcla LEFT JOIN proveedor AS pvv ON ar.codpv=pvv.codpv  LIMIT $limit, $nroLotes ");
  	...
  	$tabla = $tabla.'<table class="table table-striped table-condensed table-hover table-bordered titi">
			            <tr>
			                ...
			                <td width="7%" align="center">Costo Unitario</td>
			                <td width="5%" align="center">Saldo</td>
			                <td width="5%" align="center">Stock Min.</td>
							
							<td width="5%" align="center">U.Medida</td>
	...
	$stom=$registro2['stockmin'];	
		$tabla = $tabla.'<tr>
							...
							<td align="center"> <a href="javascript:eliminaPer('.$registro2['codar'].');" ><img src="../recursos/borrar.png" data-toggle="tooltip" title="Eliminar "></a></td>
						  </tr>';		
	}
