<?php
	...
	while($registro2 = mysqli_fetch_array($registro)){
		...
		$tabla = $tabla.'<tr>
							...
							<td><span class="badge badge-danger">'.$registro2['saldosoli'].'</span></td>
							...
							<td align="center"> <a href="javascript:VerPlanPagos('.$registro2['codsoli'].','.$registro2['codcli'].');" ><img src="../recursos/detalles.png" data-toggle="tooltip" title="Detalle de Pagos"></a>  <a href="javascript:VerPlanPagosxxx('.$registro2['codsoli'].','.$registro2['codcli'].');" ><img src="../recursos/pdf.png" data-toggle="tooltip" title="Detalles del Prestamo"></a></td> 
						  </tr>';		
	}
