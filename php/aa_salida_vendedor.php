...
$vende = $objProducto->getUsuariosVen();
...
<script src="../js/myjavaSalidave.js"></script>
...
<center><h3>ENTREGA A VENDEDORES</h3></center>
</div> <!-- fin col-sm-2 -->
<div class="col-sm-4 hidden-xs" style="background-color:white;">
  ...
  <div class="panel-group coli3">
    <div class="panel panel-success">
      ...
      <div id="collapse1" class="panel-collapse collapse in">
        <div class="panel-body">
            ...
            <input type="hidden" readonly id="idusu" name="idusu" value="<?php echo $id_usu;?>">
            	     ...
            	     <div class="row">
              			...
              			<div class="col-md-5">
                  		<span class="help-block text-muted small-font" > Vendedor</span>
                                <select name="cven" id="cven" class="form-control" >
                        <?php foreach($vende as $dato1):?>
                                    <option value="<?php echo $dato1['id_per']?>"><?php echo $dato1['nomb_usu']?></option>
						<?php endforeach;?>
                                </select>
						</div>                        
        ...
        <div class="panel-footer"><button type="button" class="btn btn-success guardar-vendedor" accesskey="g"> <span class="glyphicon glyphicon-save"></span> <u>G</u>rabar Nota</button>
