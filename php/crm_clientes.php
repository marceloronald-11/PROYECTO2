...
-->
		...
		<!-- java personal -->
        <script src="../js_raos/myjavaClientes.js"></script>
...
<div class = "form-group">
<label for = "zonn" class="control-label col-xs-3 titi">Zona:</label>
 <div class="col-xs-5">
<select name="zonn" id="zonn" class="form-control" >
 <option value="0">Ninguno</option>
	<?php foreach($zonasx as $dato1):?>
<option value="<?php echo $dato1['codzo']?>"><?php echo $dato1['detzona']?></option>
	<?php endforeach;?>
	</select>
</div>
</div>	
		    ...
		    <div class="form-group">
        			...
        			<input type="text" autocomplete="off" class="form-control" id="dircli"  name="dircli" required placeholder="Direccion ">
                    </div>
    			</div>				
