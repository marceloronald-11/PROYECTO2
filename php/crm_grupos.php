...
-->
		...
		<!-- java personal -->
        <script src="../js_raos/myjavaGrupo.js"></script>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title" id="myModalLabel"><b>FORM.GRUPOS</b></h4>
            </div>
            <form id="formulario" class="form-horizontal " onsubmit="return agregaRegistroClaa();">
            <div class="modal-body">
					 <input type="hidden"   id="idar" name="idar" value="0"/>
                   	<input type="hidden" required readonly id="pro" name="pro"/>


			    <div class="form-group">
        			<label class="control-label col-xs-3 titi" for="descla">Grupo :</label>
                    <div class="col-xs-9">
        			<input type="text" class="form-control" id="descla" name="descla" required autocomplete="off" placeholder="Grupo ">
                    </div>
    			</div>
				
			    <div class="form-group">
        			<label class="control-label col-xs-3 titi" for="pref">Prefijo :</label>
                    <div class="col-xs-4">
        			<input type="text" class="form-control" id="pref" name="pref" required autocomplete="off" placeholder="prefijo ">
                    </div>
    			</div>
