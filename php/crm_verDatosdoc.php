...
$registro = mysqli_query($conexion,"SELECT * FROM documentos WHERE codfile='$id' ");
...
<td align="center"><a href="../archivos/'.$registro2['fotodoc'].'" target="_blank"><img src="../recursos/subir2.png" data-toggle="tooltip" title="Descargar"></a>
							...
							<td align="center"> <a href="javascript:eliminaDocumento('.$registro2['coddoc'].','.$registro2['codfile'].');" ><img src="../recursos/borrar.png" data-toggle="tooltip" title="Eliminar "></a></td>
							</tr>';
						  	}
echo '<tr><td colspan="4"><a href="crm_registro.php"><img src="../recursos/salida.png" data-toggle="tooltip" title="Retornar"> SALIR ...</a></td>
</tr>';
echo '</table>';
?>