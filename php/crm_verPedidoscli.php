...
<tr><td width="70%" class="fa6"><h2>NOTA DE PEDIDO</h2></td><td align="left" class="fa5">Coalix Ventas Gina Machicado La Paz-Bolivia</td></tr> 
</table>
...
while ($row22 = mysqli_fetch_array($roww)) {
	$tt+=$row22['subtot'];
?>
<tr ><td WIDTH="5%" align="center" class="tablita"><?php echo $row22['cant'];?></td><td WIDTH="30%" class="tablita"><?php echo $row22['descripdt'];?></td><td WIDTH="7%" align="right" class="tablita"><?php echo $row22['precio'];?></td><td WIDTH="10%" align="right" class="tablita"><?php echo $row22['subtot'];?></td>
</tr>
<?php	
}
?>
...
<tr><td colspan="4"><a href="coa_pedidocli.php"><img src="../recursos/salida.png" data-toggle="tooltip" title="Retornar a Recetas"> SALIR</a></td></tr>	
</table>	
