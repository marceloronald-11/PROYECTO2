...
$pdf->Cell(70, 8, '', 0);
$pdf->Cell(100, 8, 'REPORTE DE PERSONAL', 0);
$pdf->Ln(5);
$pdf->Cell(60, 8, '', 0);
...
$pdf->Cell(25, 8, 'CI.', 0);
$pdf->Cell(50, 8, 'Cargo', 0);
$pdf->Cell(60, 8, 'Area', 0);
...
$productos = mysql_query("SELECT * FROM personal");
...
while($productos2 = mysql_fetch_array($productos)){
	...
	$pdf->Cell(70, 8, $productos2['direccion'], 0);
	$pdf->Cell(25, 8, $productos2['ci'], 0);
	$pdf->Cell(50, 8, $productos2['cargo'], 0);
	$pdf->Cell(50, 8, $productos2['area'], 0);
