...
$paimprimir = $objProducto->getVales();

$nrox = $objProducto->getCodnu();
foreach($nrox as $nn):
    $nro1= $nn['nvales']+1;
endforeach;
...
<form  class="form-horizontal" id="formulario">
				...
				<table width="100%" class="table table-responsive table-bordered" " >
					<tr><td rowspan="3" align="center"> <img class="img-responsive" src="../recursos/jachalogo.jpg" alt="Jacha Inti" width="140px" Height="140px"></td><td rowspan="3" align="center"><h2>VALES c/CODIGO</h2></td><td>No Orden </td><td><input type="text" class="form-control" id="nordenx" name="nordenx" required placeholder="No Orden"  value="<?php echo $nro1;?>"></td></tr>
					<tr><td>Tipo Cambio:</td><td><input type="text" class="form-control" id="tca" name="tca" required placeholder="Tipo Cambio " value="0" ></td></tr>
					...
					<tr><td colspan="4" align="center"><h3>FORMULARIO DE INGRESO DE DATOS</h3></td></tr>
					
					<tr><td >No de OTE:</td><td><input type="text" class="form-control" id="ootes" name="ootes" required placeholder="No Ote"></td><td align="right">Detalle OTE</td><td><input type="text" class="form-control" id="nomote" name="nomote" required placeholder="Detalle OTE "></td></tr>
					<tr><td>Tecnico :</td><td><input type="text" class="form-control" id="notec" name="notec" required placeholder="Nombre Tecnico"></td><td align="right">Fecha Salida :</td><td><input type="date" class="form-control" id="fesal" name="fesal" value="<?php echo $fecha;?>" required ></td></tr>
					
					</table>				


<div class="row">
<input type="hidden" class="form-control" id="codotex" name="codotex">
<input type="hidden" class="form-control" id="codigotecx" name="codigotecx">
<input type="hidden" class="form-control" id="codrepx" name="codrepx">
	   ...
	   <div class="col-md-1">
        ...
        <div class="col-md-1">
            <span class="help-block text-muted small-font" >P.Unit:</span>
           <input type="text" class="form-control" id="peu" name="peu" required placeholder="Unit">
       </div>
       <div class="col-md-1">
            <span class="help-block text-muted small-font" >Costo U$:</span>
           <input type="text" class="form-control" id="cost" name="cost" required placeholder="Costo U$">
       </div>
       <div class="col-md-1">
            <span class="help-block text-muted small-font" >Importe Bs:</span>
           <input type="text" class="form-control" id="imbs" name="imbs" required placeholder="Imp.Bs">
       </div>
       <div class="col-md-1">
            <span class="help-block text-muted small-font" >Stock:</span>
           <input type="text" class="form-control" id="sto" name="sto" required placeholder="Stock">
       </div>


		<div class="col-md-2">
        	<span class="help-block text-muted small-font" > ..</span>
		<input type="button"  value="Agregar" class="btn btn-info btn-sm btn-agregar-ote titu"/>
		<button type="button" class="btn btn-danger btn-sm" id="btn-GuardaVale">Guardar Nota</button>
        ...
        <div class="panel-body">
					<table class="table titi" width="100%">
					        <tr>
					            ...
					            <td align="center">OTE</td>
					            <td align="center">Detalle OTE</td>
				    	...
				    	foreach($paimprimir as $dett2){ 
								$fexx= date("d-m-Y", strtotime($dett2['fechatot']) );
								//$tmmx=$dett2['tmm'];
									?>
										<tr>
											<td width="20%" align="center"><?php echo $fexx;?></td>
											<td width="7%" align="center"><?php echo $dett2['norden'];?></td>
											<td width="15%" align="center"><?php echo $dett2['nomtec'];?></td>
											<td width="15%" align="center"><?php echo $dett2['nroote'];?></td>

												<td width="15%" align="center"><?php echo $dett2['detote'];?></td>
    ...
    <div class="modal fade" id="labo-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <form id="formulariomm" class="form-horizontal " onsubmit="return agregaRegistroCoss();">
