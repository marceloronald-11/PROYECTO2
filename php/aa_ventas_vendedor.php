...
<script src="../js/myjavaVend1.js"></script>
...
<center><h3>VENTAS VENDEDOR</h3></center>
</div> <!-- fin col-sm-2 -->
<div class="col-sm-4 hidden-xs" style="background-color:white;">
...
-->                                </select>
        ...
        <div class="panel-footer"><button type="button" class="btn btn-success guardar-vventa" accesskey="g"> <span class="glyphicon glyphicon-save"></span> <u>G</u>rabar Nota</button>
