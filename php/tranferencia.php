...
<title>Tranferencias VENTAS</title>
<link href="../css/estilo.css" rel="stylesheet">
<script src="../js/jquery.js"></script>
<script src="../js/myjava6.js"></script>
...
<body>
    <header>TRANSFERENCIAS DE ARTICULOS</header>
    <section>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title" id="myModalLabel"><b>MODULO DE TRANSFERENCIAS</b></h4>
            </div>
            ...
            <div class="modal-body">
				<table border="0" width="100%">
                    ...
                    <tr>
                    	<td>Cantidad: </td>
                        <td><input type="text"   name="cant" id="saldo"/></td>
                    </tr>     
   
                  	<tr>
                    	<td>id_per </td>
                        <td><input type="text"   name="id_per" id="id_per"/></td>
                    </tr> 
            ...
            <div class="modal-footer">
                ...
                <input type="submit" value="TRANSFERIR" class="btn btn-warning"  id="edi"/>
            </div>
            </form>
          </div>
        </div>
