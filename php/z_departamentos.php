...
<script src="../js/myjavadepto.js"></script>
...
<center><h3>MODULO: DEPARTAMENTOS</h3></center>
</div> <!-- fin col-sm-2 -->
<div class="col-sm-4" style="background-color:white;">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
			    ...
			    <div class="form-group">
        			<label class="control-label col-xs-3 titi" for="nomb">Departamento:</label>
                    <div class="col-xs-9">
        			<input type="text" class="form-control" id="nomb" name="nomb" required placeholder="Departamento ">
                    </div>
    			</div>
