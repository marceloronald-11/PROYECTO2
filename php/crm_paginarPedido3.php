<?php
    ...
    $nroProductos = mysqli_num_rows(mysqli_query($conexion,"SELECT * FROM movimtot AS mv LEFT JOIN sucursal AS su ON mv.codsuc=su.codsuc  WHERE mv.tipo='E' AND mv.tmm='Envio'"));
    $nroLotes = 10;
    ...
    if($paginaActual < $nroPaginas){
  	...
  	$registro = mysqli_query($conexion,"SELECT * FROM movimtot AS mv LEFT JOIN sucursal AS su ON mv.codsuc=su.codsuc  WHERE mv.tipo='E' AND mv.tmm='Envio' LIMIT $limit, $nroLotes ");
