...
$proceso= $_POST['proplan'];

$fechax= $_POST['fechax'];
$capitalx = $_POST['capitalx'];
$interesx = $_POST['interesx'];
$cargosx = $_POST['cargosx'];
$garantiax = $_POST['garantiax'];

$cuotax=$capitalx+$interesx+$cargosx+$garantiax;
...
switch($proceso){
	case 'Registro':
			...
			mysqli_query($conexion,"INSERT INTO planpagos (codcli,fechaplan,capital,interes,cargos,garantia,cuota,saldo,codsoli)VALUES ('$codclixx','$fechax','$capitalx','$interesx','$cargosx','$garantiax','$cuotax','0','$codsolixx')");
