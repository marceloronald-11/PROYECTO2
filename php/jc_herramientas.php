...
-->
		...
		<!-- java personal -->
        <script src="../js_raos/myjavaHerra.js"></script>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title" id="myModalLabel"><b>MAQ/HERRAMIENTAS</b></h4>
            </div>
            <form id="formulario" class="form-horizontal " onsubmit="return agregaRegistroHe();">
            <div class="modal-body">
					 <input type="hidden"   id="idhe" name="idhe" />
                   	<input type="hidden" required readonly id="pro" name="pro"/>


			    <div class="form-group">
        			<label class="control-label col-xs-3 titi" for="nomhe">Detalle :</label>
                    <div class="col-xs-9">
        			<input type="text" class="form-control" id="nomhe" name="nomhe" required placeholder="Detalle ">
                    </div>
    			</div>
			    <div class="form-group">
        			<label class="control-label col-xs-3 titi" for="cohh">Codigo :</label>
                    <div class="col-xs-4">
        			<input type="text" class="form-control" id="cohh" name="cohh" required placeholder="Codigo ">
                    </div>
    			</div>
				...
				<div class = "form-group">
					...
					<div class="col-xs-5">
					<select name="cpvv" id="cpvv" class="form-control" >
			    ...
			    <div class="form-group">
        			<label class="control-label col-xs-3 titi" for="mqhora">Maq/Hora :</label>
                    <div class="col-xs-4">
        			<input type="text" class="form-control" id="mqhora" name="mqhora" required placeholder="Maq/Hora ">
                    </div>
    			</div>
			    <div class="form-group">
        			<label class="control-label col-xs-3 titi" for="mqmin">Maq/Min :</label>
                    <div class="col-xs-4">
        			<input type="text" class="form-control" id="mqmin" name="mqmin" required placeholder="Maq/Min ">
                    </div>
    			</div>
