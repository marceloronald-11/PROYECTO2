...
$html .= '<table border="1" width="100%">';
$html .= '<tr><td align="center"><h4>SOLICITUD DE MATERIALES, REPUESTOS E INSUMOS</h4></td></tr>';
$html .= '</table>';
...
$html .= '<tr><td align="center">Itm</td><td align="center">N/Codigo</td><td align="center">Descripcion</td><td align="center">U.Med</td><td align="center">Cant.</td><td align="center">Prioridad</td><td align="center">Proveedor</td><td align="center">Unit.</td><td align="center">Subtotal</td></tr>';
$it=0;
...
$fi = mysqli_query($conexion,"SELECT * FROM solicituddet WHERE norden='$norden'");
 ...
 $html .= '<tr><td WIDTH="5%" align="center">'.$it.'</td><td WIDTH="10%" align="right">'.$row22['codigo'].'</td><td WIDTH="30%">'.$row22['detrepdt'].'</td><td WIDTH="5%" align="center">'.$row22['umed'].'</td><td WIDTH="10%" align="center">'.$row22['cantsoli'].'</td><td WIDTH="10%" align="center">'.$nota.'</td><td WIDTH="10%" align="center"></td><td WIDTH="10%" align="center"></td><td WIDTH="10%" align="center"></td>';
 $html .= '</tr>';
 }
...
$pdf->stream("Solicitud_".rand(10,10000).".pdf", array("Attachment" => false));
