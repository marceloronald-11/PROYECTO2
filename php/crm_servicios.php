...
-->
		...
		<!-- java personal -->
        <script src="../js_raos/myjavaServicioscr.js"></script>
						...
						<div class="nav-search" id="nav-search">
							<form class="form-search">
								<span class="input-icon">
									<input type="text" placeholder="Buscar ..." class="nav-search-input buscaservi" id="nav-search-input" autocomplete="off" />
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title" id="myModalLabel"><b>FORMULARIO SERVICIOS</b></h4>
            </div>
            <form id="formulario" class="form-horizontal " onsubmit="return agregaRegistroServi();">
            <div class="modal-body">
			    ...
			    <div class="form-group">
        			<label class="control-label col-xs-3 titi" for="nomar">Servicio :</label>
                    <div class="col-xs-9">
