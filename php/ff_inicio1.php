      ...
      <div class="sidebar">
        ...
        <div class="sidebar-inner">
          ...
          <ul class="nav nav-sidebar">
            ...
            <li class="nav-parent">
              <a href="#"><i class="icon-puzzle"></i><span>GRUPOS</span> <span class="fa arrow"></span></a>
              <ul class="children collapse">
                <li><a  href="ff_articulos.php"> Articulos</a></li>
            ...
            <li class="nav-parent">
              ...
              <ul class="children collapse">
                ...
                <li><a href="../extra-translation.html"> Translation</a></li>
                        ...
                        <li><a href="logout.php"><i class="icon-power"></i><span>Cerrar Sesion</span></a></li>
...
-->              </ul>
          ...
          <div class="header-right">
            <ul class="header-menu nav navbar-nav">
              ...
              <li class="dropdown" id="user-header">
                ...
                <span class="username">Hola, Raul Rodriguez</span>
                </a>
                <ul class="dropdown-menu">
                  <li>
                  ...
                  <li>
                    <a href="#"><i class="icon-calendar"></i><span>Mi Calendario</span></a>
                  </li>
                  <li>
                    <a href="logout.php"><i class="icon-logout"></i><span>Cerrar Sesion</span></a>
                  </li>
                </ul>
              </li>
              <!-- END USER DROPDOWN -->
    ...
    <script src="../assets/admin/layout1/js/layout.js"></script> <!-- Main Application Script -->
      </body>
</html>