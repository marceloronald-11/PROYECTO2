...
<script src="../js/myjavactivo3a.js"></script>
...
<center><h3>ARTICULOS REPORTE ETIQUETAS</h3></center>
</div> <!-- fin col-sm-2 -->
<div class="col-sm-4" style="background-color:white;">
...
-->      </span>
    ...
    <td>
    		    <div class="input-group col-xs-3">
                    <div class="col-xs-3">
<!--				     	<a target="_blank" href="javascript:reporteExcel();" class="btn btn-success btn-sm">Exportar a Excel</a>
-->                    </div>
    			</div>
	</td>    
...
<td>
    		    <div class="input-group col-xs-3">
                    <div class="col-xs-3">
				     	<a target="_blank" href="javascript:reportePDF();" class="btn btn-danger btn-sm">Exportar Etiquetas a PDF</a>
                    </div>
    			</div>
	</td>    
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
			    ...
			    <div class="form-group">
        			<label class="control-label col-xs-3 titi" for="pnet">Precio Neto:</label>
                    <div class="col-xs-3">
        			<input type="text" class="form-control" id="pnet" name="pnet" required placeholder="Precio Neto">
                    </div>
    			</div>
			    <div class="form-group">
        			<label class="control-label col-xs-3 titi" for="pvp">Precio Venta:</label>
                    <div class="col-xs-3">
        			<input type="text" class="form-control" id="pvp" name="pvp" required placeholder="Precio Venta">
                    </div>
    			</div>
