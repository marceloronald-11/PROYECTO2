...
-->
		...
		<!-- java personal -->
        <script src="../js_raos/myjavasaldosGral.js"></script>
				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS ///////////////////////////////////////////////////////////// -->
											<!--<button class="btn btn-white btn-info btn-bold" id="saldosGral">
												<i class="ace-icon fa fa-folder-open-o bigger-50 blue"></i>
												NUEVO
											</button>-->
								<button class="btn btn-red btn-info btn-bold" onclick="javascript:VerSaldos()">PROCESAR SALDOS</button>
