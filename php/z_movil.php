...
<link rel="stylesheet" href="../css/estiloini3.css" />
<!-- JS JAVAS PERSONALIZADO -->
...
<center><h4>TRANSPORTE</h4></center>
</div> <!-- fin col-sm-2 -->
<div class="col-sm-4 hidden-xs" style="background-color:82b1e9;">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <ul class="nav navbar-nav">
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="aa_transporte2.php">SOLICITUDES</a></li>
          </ul>
        </li>
      </ul>
      ...
      <ul class="nav navbar-nav">
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="#">REPORTES DE SERVICIO</a></li>
          </ul>
        </li>
      </ul>
