...
<br>
<div class="row titulo" style="background-color:#ad0e0e; color:#FFF; "> 
		<div class="col-md-2" >
		...
		<div class="col-md-6">
            	<table class="table"><tr><td align="center"><h2>COMPRA DE ARTICULOS</h2></td></tr></table>
		</div>
...
<div class="row" > 
		...
		<center><h4>BUSQUEDA DE ARTICULOS</h4></center>
...
-->             
             	     <div class="row">
                  		...
                  		<input type="text" class="form-control input-sm" id="buscaract" placeholder="Buscar..." />
              			</div>
					</div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
			...
			<div class="form-group">
				...
				<div class="form-group">
   					<label for="nomcli" class="control-label col-xs-3">Encargado(a):</label>
      					<div class="col-xs-8">
          					<input type="text" class="form-control" id="nomcli" value="<?php echo $nousuario;?>"   placeholder="Señores">
       					</div>
				</div>        
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-primary guardar-carrito3 btn-sm" accesskey="g"><u>G</u>rabar Nota</button>
