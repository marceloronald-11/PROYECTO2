...
-->
		...
		<!-- java personal -->
        <script src="../js_raos/myjavaVentasuc.js"></script>
    ...
    <div class="modal fade" id="sucu-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <form id="formulario" class="form-horizontal " onsubmit="return agregaRegistroConfi();">
            <div class="modal-body">
			    ...
			    <div class="form-group">
        			<label class="control-label col-xs-3 titi" for="encargo">Encargado :</label>
                    <div class="col-xs-8">
        			<input type="text" class="form-control" id="encargo" name="encargo" required placeholder="Encargado ">
                    </div>
    			</div>
			    <div class="form-group">
        			<label class="control-label col-xs-3 titi" for="fechacf">Fecha:</label>
                    <div class="col-xs-4">
        			<input type="date" class="form-control" id="fechacf" name="fechacf" required >
                    </div>
    			</div>
			    ...
			    <div class="form-group">
        			<label class="control-label col-xs-3 titi" for="nord">No Orden:</label>
                    <div class="col-xs-4">
        			<input type="text" class="form-control" id="nord" name="nord" required placeholder="No Orden ">
                    </div>
    			</div>
            ...
            <div class="modal-footer">
                ...
                <input type="submit" value="Confirmar Pedido" class="btn btn-warning"  id="edi"/>
