...
-->
		...
		<!-- java personal -->
        <script src="../js_raos/myjavaTec.js"></script>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title" id="myModalLabel"><b>TECNICOS FORM.</b></h4>
            </div>
            <form id="formulario" class="form-horizontal " onsubmit="return agregaRegistroTec();">
            <div class="modal-body">
			    ...
			    <div class="form-group">
        			<label class="control-label col-xs-3 titi" for="nomtec">Nombre Tecnico :</label>
                    <div class="col-xs-9">
        			<input type="text" class="form-control" id="nomtec" name="nomtec" required placeholder="Nombre del Tecnico ">
                    </div>
    			</div>
			    <div class="form-group">
        			<label class="control-label col-xs-3 titi" for="cotc">Codigo :</label>
                    <div class="col-xs-4">
        			<input type="text" class="form-control" id="cotc" name="cotc" required placeholder="Codigo ">
                    </div>
    			</div>
			    <div class="form-group">
        			<label class="control-label col-xs-3 titi" for="hosus">Hora U$:</label>
                    <div class="col-xs-4">
        			<input type="text" class="form-control" id="hosus" name="hosus" required placeholder="HoraU$ ">
                    </div>
    			</div>

			    <div class="form-group">
        			<label class="control-label col-xs-3 titi" for="misus">Min U$ :</label>
                    <div class="col-xs-4">
        			<input type="text" class="form-control" id="misus" name="misus" required placeholder="Min U$ ">
                    </div>
    			</div>

			    <div class="form-group">
        			<label class="control-label col-xs-3 titi" for="diretec">Direccion :</label>
                    <div class="col-xs-9">
        			<input type="text" class="form-control" id="diretec" name="diretec"  placeholder="Direccion ">
                    </div>
    			</div>

			    <div class="form-group">
        			<label class="control-label col-xs-3 titi" for="teltec">Telefono :</label>
                    <div class="col-xs-9">
        			<input type="text" class="form-control" id="teltec" name="teltec"  placeholder="Telefono ">
                    </div>
    			</div>

			    <div class="form-group">
        			<label class="control-label col-xs-3 titi" for="celtec">Celular :</label>
                    <div class="col-xs-9">
        			<input type="text" class="form-control" id="celtec" name="celtec"  placeholder="Celular ">
                    </div>
    			</div>
