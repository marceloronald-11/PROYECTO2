...
<script src="../js/myjavamensual.js"></script>
...
<center><h3>REPORTES DE PAGOS MENSUALES</h3></center>
</div> <!-- fin col-sm-2 -->
<div class="col-sm-4" style="background-color:white;">
...
<a href="z_movim1.php" class="btn btn-primary"><span class="glyphicon glyphicon-user"></span> Movimientos</a>
...
<div class="col-sm-10" style="background-color:white;">
    ...
    <div class="input-group col-xs-3">
     	Desde:<input type="date" class="form-control" placeholder="Desde" id="fei" >
    </div>
    </td>
    <td width="20%">
    <div class="input-group col-xs-3">
    	Hasta:<input type="date" class="form-control" placeholder="Hasta" id="fef" >
    </div>
    ...
    <td width="20%">
    <div class="input-group col-xs-3">
    	<a target="_blank" href="javascript:reportePDF();" class="btn btn-danger btn-sm">Ingresos a PDF</a>
    </div>
	</td>
    <tr>
