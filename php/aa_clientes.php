...
<script src="../js/myjavaCli.js"></script>
...
<center><h4>MODULO DE CLIENTES</h4></center>
</div> <!-- fin col-sm-2 -->
<div class="col-sm-4 hidden-xs" style="background-color:white;">
    ...
    <div class="modal fade" id="registra-artis" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title" id="myModalLabel"><b>Registro/Edicion Clientes</b></h4>
            </div>
     ...
     <div class="row">
         		<div class="col-md-4">
                  ...
                  <input type="text" class="form-control input-sm" name="nocli" id="nocli" placeholder="Cliente"   />
              	</div>
         		<div class="col-md-4">
                  <span class="help-block text-muted small-font tipe" >  No Carnet:</span>
                  <input type="text" class="form-control input-sm" id="cii" name="cii" placeholder="No Carnet" />
              	</div>

         		<div class="col-md-4">
                  <span class="help-block text-muted small-font tipe" >  Nit :</span>
                  <input type="text" class="form-control input-sm" id="nit" name="nit" placeholder="Nit " />
              	</div>
     ...
     <div class="row">
                  ...
                  <input type="text" class="form-control input-sm" id="dire" name="dire"  placeholder="Direccion" />
              	</div>

          		<div class="col-md-4">
                  <span class="help-block text-muted small-font tipe" >  E-mail:</span>
                  <input type="text" class="form-control input-sm" id="emma" name="emma" placeholder="E-mail" />
              	</div>
      </div>

     <div class="row">
         		<div class="col-md-4">
                  <span class="help-block text-muted small-font tipe" > Zona:</span>
                  <input type="text" class="form-control input-sm" name="zna" id="zna" placeholder="Zona"   />
              	</div>
     
         		<div class="col-md-4">
                  <span class="help-block text-muted small-font tipe" >  Telf/Cel:</span>
                  <input type="text" class="form-control input-sm" id="cel" name="cel" placeholder="Telf/Cel" />
              	</div>
     
     
         		<div class="col-md-4">
                  <span class="help-block text-muted small-font tipe" >  Observaciones:</span>
 					<textarea class="form-control" rows="2" id="observv"  name="observv" placeholder="Observaciones"></textarea>
              	</div>
      </div>
