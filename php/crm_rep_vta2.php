...
-->
		...
		<!-- java personal -->
        <script src="../js_raos/myjavaVta2.js"></script>
...
<label class="control-label col-xs-1 titi1" for="idux">Cliente :</label>
<div class="col-xs-3">
<select name="idux" id="idux" class="form-control" >
 <option value="0">Ninguno</option>
	<?php foreach($pper as $dato1):?>
<option value="<?php echo $dato1['codcli']?>"><?php echo $dato1['nombrecli']?></option>
	<?php endforeach;?>
	</select>
