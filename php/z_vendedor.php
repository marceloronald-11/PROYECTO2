...
<script src="../js/jquery.numeric.js"></script>
	<link rel="stylesheet" href="../css/estiloini6.css" />
...
<center><h4>VENDEDORES</h4></center>
</div> <!-- fin col-sm-2 -->
<div class="col-sm-4 hidden-xs" style="background-color:#82b1e9;">
...
<!--       <li><a href="aa_confirmSuc3.php">RECEPCION DE ARTICULOS</a></li>
            <li class="divider"></li>
           <li><a href="aa_ventas_vendedor.php">VENTAS CLIENTES</a></li>
            <li class="divider"></li> --> 
            <li><a href="aa_pedido_vendedor.php">PEDIDOS</a></li>            
<!--            <li class="divider"></li>
...
-->
      ...
      <ul class="nav navbar-nav">
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="aa_pagos_creven.php">PAGO DE CREDITOS</a></li>
          </ul>
        </li>
      </ul>
...
<!--              <li><a href="#">CREDITOS</a></li>
          ...
          <li><a href="#">NOTAS DE SALIDA</a></li>
            <li><a href="aa_kardexAlm3.php">KARDEX </a></li>
            <li><a href="aa_Consulta1.php">CONSULTA SUCURSALES</a></li>
-->
          </ul>
        </li>
      </ul>
