...
-->
		...
		<!-- java personal -->
        <script src="../js_raos/myjavaPlan.js"></script>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title" id="myModalLabel"><b>FORM.PLAN PAGOS</b></h4>
            </div>
            <form id="formulario" class="form-horizontal " onsubmit="return agregaRegistroPlan();">
            <div class="modal-body">
					 <input type="text"   id="idper" name="idper" value="0"/>
