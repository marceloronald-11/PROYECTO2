...
-->
		...
		<!-- java personal -->
        <script src="../js_raos/myjavaPross.js"></script>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title" id="myModalLabel"><b>PROCESOS</b></h4>
            </div>
            <form id="formulario" class="form-horizontal " onsubmit="return agregaRegistroPross();">
...
<div class="row">
   <div class="col-md-8">
	...
	<input type="text" readonly class="form-control input-sm" id="codprosi" name="codprosi" placeholder="Codigo" />
	</div>
</div>
...
<div class="row">
   <div class="col-md-12">
	...
	<input type="text" class="form-control input-sm" id="nompros" name="nompros" placeholder="Detalle" />
	</div>
</div>
