...
<tr><td width="150" ><?php echo $f['nombre']; ?></td></tr>
<tr><td width="150"><?php	echo '<img src="'.$f['foto'].'" width="400" heigth="400"/>';?></td></tr>
<?php } ?>
</table>

<form action="z_subirproveedor.php" method="post" id="formulario" enctype="multipart/form-data">
