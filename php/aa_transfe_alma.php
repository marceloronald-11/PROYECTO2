...
$succ = $objProducto->getSucursalVar($codsucx);
...
<script src="../js/myjavaTraAlm.js"></script>
...
<center><h3>TRANSFERENCIAS SUCURSAL</h3></center>
</div> <!-- fin col-sm-2 -->
<div class="col-sm-4 hidden-xs" style="background-color:white;">
