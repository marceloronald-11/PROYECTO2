...
-->
		...
		<!-- java personal -->
        <script src="../js_raos/myjavaPerso.js"></script>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
			    ...
			    <div class="form-group">
        			<label class="control-label col-xs-3 titi" for="nomcli">Nombre :</label>
                    <div class="col-xs-9">
			    ...
			    <div class="form-group">
        			<label class="control-label col-xs-3 titi" for="telf">Telefono :</label>
                    <div class="col-xs-9">
