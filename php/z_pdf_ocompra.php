...
mysqli_query($conexion,"UPDATE ordentot SET imprimio='SI' WHERE norden='$norden'");




$row = mysqli_query($conexion,"SELECT * FROM ordentot AS ord JOIN departamento AS dp ON ord.coddep=dp.coddep WHERE norden='$norden'");
...
$html .= '<tr><td align="left" class="lfactura">ORDEN DE COMPRAS</td></tr>';
...
$roww = mysqli_query($conexion,"SELECT * FROM ordendet WHERE norden='$norden'");
