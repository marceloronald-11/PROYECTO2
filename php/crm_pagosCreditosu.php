...
-->
		...
		<!-- java personal -->
        <script src="../js_raos/myjavaPagaru.js"></script>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
        			...
        			<input type="hidden"  id="nosucc" name="nosucc" >
        			<input type="hidden"  id="codclix" name="codclix" >


			    <div class="form-group">
        			<label class="control-label col-xs-3 titi" for="nordenxx">No Orden :</label>
                    <div class="col-xs-5">
        			<input type="text" class="form-control" readonly id="nordenxx" name="nordenxx" required placeholder="No Orden">
                    </div>
    			</div>
			    ...
			    <div class="form-group">
        			<label class="control-label col-xs-3 titi" for="ncliente">Cliente :</label>
                    <div class="col-xs-7">
			    ...
			    <div class="form-group">
                    ...
                    <div class="col-xs-5">
        			<input type="text" class="form-control" id="pagui" name="pagui" required autocomplete="off" placeholder="Monto Pagar">
                    </div>
    			</div>
