...
$labox = $objProducto->getlaboratorio();
				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS ///////////////////////////////////////////////////////////// -->
											<button class="btn btn-white btn-info btn-bold" id="nuevo-producto">
												<i class="ace-icon fa fa-folder-open-o bigger-50 blue"></i>
												NUEVO
											</button>
<!--											<button class="btn btn-white btn-info btn-bold" href="javascript:reportePDF();" id="reportePDF">
...
-->
<a target="_blank" href="javascript:reportePDF();" class="btn btn-white btn-info btn-bold" role="button"><i class="ace-icon fa fa-file-pdf-o bigger-50 red"></i> a PDF</a>
<a target="_blank" href="javascript:reporteExcel();" class="btn btn-white btn-info btn-bold" role="button"><i class="ace-icon fa fa-file-excel-o bigger-50 green"></i> a Excel</a>
  ...
  <div class="modal fade" id="modalArticulo">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <!-- Modal body -->
       		<form id="formulario" onsubmit="return agregaProducto();">
        ...
        <div class="modal-body">
        		 ...
        		 <!-- </form> -->
					...
					<input type="hidden" class="form-control" id="idcod" name="idcod">

  <div class="row">
                <div class="form-group col-md-9">
                  <label for="desart">Descripcion:</label>
                  <input type="text" class="form-control" id="dess" name="dess" placeholder="Articulo">
                </div>
            
                <div class="form-group col-md-3">
                  <label for="cant">Codigo</label>
                  <input type="text" class="form-control" id="codi" name="codi" placeholder="Codigo">
                </div>
  </div>

  <div class="row">
                <div class="form-group col-md-3">
                  <label for="ume">U.Med:</label>
                  <input type="text" class="form-control" id="ume" name="ume" placeholder="U.Medida">
                </div>
            
                <div class="form-group col-md-3">
                  <label for="conte">Contiene:</label>
                  <input type="text" class="form-control"  id="conte" name="conte" placeholder="Contiene">
                </div>
                <div class="form-group col-md-3">
                  <label for="neto">Precio Neto:</label>
                  <input type="text" class="form-control"  id="neto" name="neto" placeholder="P.Neto">
                </div>
                <div class="form-group col-md-3">
                  <label for="pvp">P.Venta:</label>
                  <input type="text" class="form-control" id="pvp" name="pvp" placeholder="P.Venta">
                </div>
  ...
  <div class="row">
                <div class="form-group col-md-3">
                  <label for="sto">Stock Min:</label>
                  <input type="text" class="form-control" id="sto" name="sto" placeholder="Stock Min.">
                </div>
            
                <div class="form-group col-md-6">
                  <label for="ubi">Ubicacion:</label>
                  <input type="text" class="form-control"   id="ubi" name="ubi" placeholder="Ubicacion">
                </div>
                <div class="form-group col-md-3">
                  <label for="cnt">Controlado:</label>
  ...
  <div class="row">
                <div class="form-group col-md-6">
                  <label for="cla">Clasificacion:</label>
                ...
                <div class="form-group col-md-6">
                  <label for="lab">Laboratorio:</label>
                        <select name="lab" id="lab" class="form-control" >
                         		<option value="0">Ninguno</option>
                            		<?php foreach($labox as $lb):?>
                        		<option value="<?php echo $lb['codlab']?>"><?php echo $lb['nombrelab']?></option>
                            		<?php endforeach;?>
                         </select>
                </div>
  </div>
  ...
  <div class="row">
                <div class="form-group col-md-6">
                  <label for="feven">Vencimiento:</label>
                  <input type="date" class="form-control" id="feven" name="feven" >
                </div>
            
                <div class="form-group col-md-3">
                  <label for="nlote">No Lote:</label>
                  <input type="text" class="form-control"  id="nlote" name="nlote" placeholder="No Lote">
                </div>
  </div>

  <div class="row">
                <div class="form-group col-md-6">
                  <label for="dole">Dolencia:</label>
                    <textarea class="form-control" rows="3" id="dole"  name="dole" placeholder="Dolencias"></textarea>
                </div>
        ...
        <div class="modal-footer">
          <button  type="submit" id="edi" class="btn btn-danger" >Editar</button>
          <button  type="submit" id="reg"class="btn btn-danger" >Registrar</button>          
				...
				<div class="footer-inner">
					<div class="footer-content">
						<span class="bigger-120">
							<span class="blue bolder">SOFFA</span>
							Software &copy; 2018
						</span>
