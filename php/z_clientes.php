...
<script src="../js/myjavacliente.js"></script>
...
<a href="z_movim1.php" class="btn btn-primary"> <span class="glyphicon glyphicon-modal-window"></span> Movimientos</a>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title" id="myModalLabel"><b>CLIENTES: FORMULARIO</b></h4>
            </div>
            ...
            <div class="modal-body">
			    ...
			    <div class="form-group">
        			<label class="control-label col-xs-3 titi" for="nomb">Nombre Cliente:</label>
                    <div class="col-xs-9">
        			<input type="text" class="form-control" id="nomb" name="nomb" required placeholder="Nombre ">
                    </div>
    			</div>

			    <div class="form-group">
        			<label class="control-label col-xs-3 titi" for="ci">Nro Carnet :</label>
                    <div class="col-xs-5">
			    ...
			    <div class="form-group">
        			<label class="control-label col-xs-3 titi" for="cod">Codigo:</label>
                    <div class="col-xs-5">
        			<input type="text" class="form-control" id="cod" name="cod" required placeholder="Codigo">
                    </div>
    			</div>
			    <div class="form-group">
        			<label class="control-label col-xs-3 titi" for="fenac">Fecha Nac :</label>
                    <div class="col-xs-5">
        			<input type="date" class="form-control" id="fenac" name="fenac"  placeholder="Fecha Nac.">
                    </div>
    			</div>
                
			    <div class="form-group">
        			<label class="control-label col-xs-3 titi" for="edad">Edad:</label>
                    <div class="col-xs-3">
			    ...
			    <div class="form-group">
        			<label class="control-label col-xs-3 titi" for="sex">Sexo:</label>
                    <div class="col-xs-3">
        			           	<input type="radio"  name="sex" CHECKED id="MA" value="M">Masc.
								<input type="radio"  name="sex" id="FE" value="F"> Fem. 
			    ...
			    <div class="form-group">
        			<label class="control-label col-xs-3 titi" for="dire">Direccion :</label>
                    <div class="col-xs-9">
			    ...
			    <div class="form-group">
        			<label class="control-label col-xs-3 titi" for="cel">Telf/Celular :</label>
                    <div class="col-xs-9">
        			<input type="text" class="form-control" id="cel" name="cel" required placeholder="Telefono">
                    </div>
    			</div>

			    <div class="form-group">
        			<label class="control-label col-xs-3 titi" for="email">Correo Electronico :</label>
                    <div class="col-xs-9">
        			<input type="email" class="form-control" id="email" name="email"  placeholder="TuCorreo@com">
                    </div>
    			</div>
                    		...
                    		<div class="form-group">
                		    	...
                		    	<div class="col-xs-9">
 				 					<textarea class="form-control" rows="3" required id="observ"  name="observ" placeholder="Observaciones"></textarea>
                     			</div>
							</div>                
