...
<input type="hidden" class="form-control" value="0" id="codareax" name="codareax" >
<input type="hidden" class="form-control" value="0" id="codcargox" name="codcargox" >
<input type="hidden" class="form-control" value="0" id="codsolix" name="codsolix" >
        ...
        <div class="modal-dialog modal-md">
          <div class="modal-content">
            ...
            <div class="modal-body">
					 ...
					 <input type="hidden"   id="codree" name="codree" />
