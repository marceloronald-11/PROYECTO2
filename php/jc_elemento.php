...
-->
		...
		<!-- java personal -->
        <script src="../js_raos/myjavaEle.js"></script>
    ...
    <div class="modal fade" id="labo-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title" id="myModalLabel"><b>ELEMENTOS</b></h4>
            </div>
            <form id="formulario" class="form-horizontal " onsubmit="return agregaRegistroEle();">
            <div class="modal-body">
					 <input type="hidden"   id="idele" name="idele" />
                   	<input type="hidden" required readonly id="pro" name="pro"/>

		<div class="row">
         			<div class="col-md-8">
                  		<span class="help-block text-muted small-font tipe" > Costos:</span>
         		...
         		<div class="col-md-4">
                  ...
                  <input type="text" readonly class="form-control input-sm" id="ccosto1" name="ccosto1" placeholder="Codigo" />
              	</div>
      </div>
      ...
      <div class="row">
         		<div class="col-md-8">
				  ...
				  <select  id="lb2" name="lb2" class="form-control" >
                  </select>
              	</div>
    
         		<div class="col-md-4">
                  <span class="help-block text-muted small-font tipe" >....</span>
                  <input type="text" readonly class="form-control input-sm" id="procc1" name="procc1" placeholder="Codigo" />
              	</div>
</div>
...
<div class="row">
         		<div class="col-md-8">
				  ...
				  <select  id="lb3" name="lb3" class="form-control" >
                  </select>
              	</div>
    
         		<div class="col-md-4">
                  <span class="help-block text-muted small-font tipe" >.... </span>
                  <input type="text" readonly class="form-control input-sm" id="maqq1" name="maqq1" placeholder="Codigo" />
              	</div>
</div>
...
<div class="row">
   <div class="col-md-8">
	...
	<input type="text" readonly class="form-control input-sm" id="codelei" name="codelei" placeholder="Codigo" />
	</div>
</div>
...
<div class="row">
   <div class="col-md-12">
	...
	<input type="text" class="form-control input-sm" id="nomele" name="nomele" placeholder="Detalle" />
	</div>
</div>
