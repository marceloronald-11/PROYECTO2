...
<tr><td width="150" ><?php echo $f['nombrepv']; ?></td></tr>
<tr><td width="150"><?php	echo '<img src="'.$f['fotopv'].'" width="200" heigth="200"/>';?></td></tr>
<?php } ?>
</table>

<form action="aa_subirPvv.php" method="post" id="formulario" enctype="multipart/form-data">
