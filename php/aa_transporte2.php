...
<script src="../js/myjavaTrans2.js"></script>
...
<center><h4>SOLICITUDES DE TRANSPORTE</h4></center>
</div> <!-- fin col-sm-2 -->
<div class="col-sm-4 hidden-xs" style="background-color:white;">
...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="z_movil.php">Menu</a>
    </div>
    ...
    <div class="modal fade" id="modalInfo" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
              <h4 class="modal-title" id="myModalLabel"><b>Formulario de Informe</b></h4>
            </div>
            <form id="formulario1" class="form-horizontal " onsubmit="return agregaRegistroInfo();">
            <div class="modal-body">
					 <input type="hidden"   id="codx" name="codx" />
                   	<input type="hidden" required readonly id="pro2" name="pro2"/>
     <div class="row">
         		<div class="col-md-3">
                  <span class="help-block text-muted small-font tipe" > Entrega:</span>
                  <input type="date" class="form-control input-sm" readonly name="feent2" id="feent2" placeholder="Fecha Entrega"   />
              	</div>

         		<div class="col-md-3">
                  <span class="help-block text-muted small-font tipe" >  Hora Entrega:</span>
                  <input type="text" class="form-control input-sm" readonly id="hoent2x" name="hoent2x" placeholder="Hora Entrega" />
              	</div>
          		<div class="col-md-3">
                  <span class="help-block text-muted small-font tipe" > Cliente:</span>
                  <input type="text" class="form-control input-sm" readonly id="clienn2" name="clienn2" placeholder="Cliente" />
              	</div>

          		<div class="col-md-3">
                  <span class="help-block text-muted small-font tipe" > Telf/Cel:</span>
                  <input type="text" class="form-control input-sm" readonly id="tcel2" name="tcel2" placeholder="Telf/Celular" />
              	</div>
     ...
     <div class="row">
         		<div class="col-md-3">
                  <span class="help-block text-muted small-font tipe" > Se Entrego:</span>
                  <input type="date" class="form-control input-sm" name="feent2" id="feent" value="<?php echo $fecha;?>"  placeholder="Fecha Entrega"   />
              	</div>

         		<div class="col-md-3">
                  <span class="help-block text-muted small-font tipe" >  Hora:</span>
                  <input type="text" class="form-control input-sm" id="hoent2" name="hoent2" value="<?php echo $horax;?>"  placeholder="Hora Entrega" />
              	</div>
          		<div class="col-md-3">
                  <span class="help-block text-muted small-font tipe" > Se Cobro:</span>
                  <input type="text" class="form-control input-sm" id="salcli2" name="salcli2" placeholder="Cobro" />
              	</div>
      </div>
     ...
     <div class="row">
         		...
         		<div class="col-md-9">
                  <span class="help-block text-muted small-font tipe" >  Observaciones:</span>
 					<textarea class="form-control" rows="2" id="obcli2"  name="obcli2" placeholder="Observaciones"></textarea>
              	</div>
      </div>
...
?>
            <div class="modal-footer">
            	<input type="submit" value="Registrar...xx" class="btn btn-success" id="reg2"/>
