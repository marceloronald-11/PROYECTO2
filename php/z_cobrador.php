...
<link rel="stylesheet" href="../css/estiloini7.css" />
<!-- JS JAVAS PERSONALIZADO -->
...
<center><h4>AREA COBRADOR</h4></center>
</div> <!-- fin col-sm-2 -->
<div class="col-sm-4 hidden-xs" style="background-color:82b1e9;">
...
<?php echo 'Usuario :'.$nombre_u.'<br>'.'Transporte'; ?>
</td></tr>
</table>
</div> <!-- fin col-sm-2 -->
</div> <!--!fin de row -->
...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <ul class="nav navbar-nav">
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="aa_pagos_crecobrador.php">REGISTRO DE CREDITOS</a></li>
      ...
      <ul class="nav navbar-nav">
        <li class="dropdown">
          <a class="media-object" data-toggle="dropdown" href="#">REPORTES<span class="caret"></span></a>
          <ul class="dropdown-menu">
            <li><a href="#">INFORME DE COBROS</a></li>
          </ul>
        </li>
      </ul>
