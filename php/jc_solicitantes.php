...
-->
		...
		<!-- java personal -->
        <script src="../js_raos/myjavaSoli.js"></script>
...
$areaa = $objProducto->getArea();
$cargoo = $objProducto->getCargo();
			...
			<div id="sidebar" class="sidebar                  responsive                    ace-save-state">
				...
				<ul class="nav nav-list">
					...
					<li class="">
						<a href="#" class="dropdown-toggle">
							<i class="menu-icon fa fa-list"></i>
							<span class="menu-text"> REQ.MNT/COMPRAS</span>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title" id="myModalLabel"><b>SOLICITANTES FORM.</b></h4>
            </div>
            <form id="formulario" class="form-horizontal " onsubmit="return agregaRegistroCar();">
            <div class="modal-body">
			    ...
			    <div class="form-group">
        			<label class="control-label col-xs-3 titi" for="nomsoli">Nombre :</label>
                    <div class="col-xs-9">
        			<input type="text" class="form-control" id="nomsoli" name="nomsoli" required placeholder="Nombre ">
                    </div>
    			</div>


				<div class = "form-group">
				<label for = "usu" class="control-label col-xs-3 titi">Area:</label>
				<div class="col-xs-9">
				<select name="are" id="are" class="form-control" >
				<option value="0">Ninguno</option>
					<?php foreach($areaa as $dato1):?>
				...
				<div class = "form-group">
				<label for = "usu" class="control-label col-xs-3 titi">Cargo:</label>
				<div class="col-xs-9">
				<select name="carg" id="carg" class="form-control" >
				<option value="0">Ninguno</option>
					<?php foreach($cargoo as $dato2):?>
				<option value="<?php echo $dato2['codcargo']?>"><?php echo $dato2['detcargo']?></option>
					<?php endforeach;?>
					</select>
				</div>
				</div>
