...
-->
						<li class="light-blue dropdown-modal">
							...
							<img class="nav-user-photo" src="<?php echo $fotito; ?>" alt="Inti" />
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
										<!-- <h1>JACHA INTI</h1> -->
										<img class="img-responsive" src="../recursos/jachalogo.jpg" alt="Jacha Inti">
								<!-- PAGE CONTENT ENDS -->
							</div><!-- /.col -->
						</div><!-- /.row -->
					</div><!-- /.page-content -->
				...
				<div class="footer-inner">
					<div class="footer-content">
						...
						<span class="action-buttons">
							...
							<a href="#">
								<i class="ace-icon fa fa-youtube red bigger-200"></i>
							</a>
						</span>
					</div>
				</div>
