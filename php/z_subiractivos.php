...
$destino="../fotos_activos/".$foto; // AUMENTA LA X DEBERIA SER UN NUMERO CORRELATIVO
...
mysqli_query($conexion,"UPDATE clientes SET foto = '$destino' WHERE idcli = '$id'");

	echo '<Script language=javascript> 
	alert("LA IMAGEN FUE SUBIDA CORRECTAMENTE...")
	self:location="z_clientes.php"	
	</script>';
 ?>
