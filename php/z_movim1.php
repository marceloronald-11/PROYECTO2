...
<script src="../js/myjavamovim.js"></script>
...
<center><h3>MOVIMIENTOS GIMNASIO</h3></center>
</div> <!-- fin col-sm-2 -->
<div class="col-sm-4" style="background-color:white;">
...
<a href="z_clientes.php" class="btn btn-primary"><span class="glyphicon glyphicon-user"></span> GYM Clientes</a>
...
<div class="col-sm-10" style="background-color:white;">
    ...
    <div class="input-group col-xs-6">
     <input type="text" class="form-control" placeholder="Buscar Cliente" id="bs-prod" >
...
<div class = "form-group">
<label for = "usu" class="control-label col-xs-3 titi">Disciplina :</label>
 <div class="col-xs-5">
    ...
    <div class="modal fade" id="registra-mes" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
              <h4 class="modal-title" id="myModalLabel"><b>FORMULARIO INSCRIPCIONES MENSUALES</b></h4>
              <h4 align="left" class="fecha">  <?php $array=array("Domingo","Lunes","Martes","Miercoles","Jueves","Viernes","Sabado");
echo "La Paz, ".$array[date("w")]." ".date("d-m-y"); ?> </h4>

            </div>
            <form id="formulario1" class="form-horizontal " onsubmit="return agregaRegistroMen();">
            <div class="modal-body">
					 <input type="hidden"   id="idper1" name="idper1" />
			    ...
			    <div class="form-group">
                    ...
                    <div class="col-xs-5">
        			<input type="text" class="form-control" readonly id="nnota1" name="nnota1" value="<?php echo $nordenx;?>" required placeholder="No Recibo ">
                    </div>
    			</div>


			    <div class="form-group">
        			<label class="control-label col-xs-3 titi" for="cli1">Cliente:</label>
                    <div class="col-xs-9">
        			<input type="text" class="form-control" id="cli1" name="cli1" readonly required placeholder="Cliente">
                    </div>
    			</div>

<div class = "form-group">
<label for = "usu1" class="control-label col-xs-3 titi1">Disciplina :</label>
 <div class="col-xs-5">
<select name="cla1" id="cla1" class="form-control" >
 <option value="0">Ninguno</option>
	<?php foreach($disi2 as $dato11):?>
<option value="<?php echo $dato11['coddisi']?>"><?php echo $dato11['descripdici']?></option>
	<?php endforeach;?>
	</select>
</div>
</div>
			    ...
			    <div class="form-group">
        			<label class="control-label col-xs-3 titi" for="fei1">Desde :</label>
                    <div class="col-xs-5">
        			<input type="date" class="form-control" id="fei1" name="fei1" required placeholder="Fecha Inicial">
                    </div>
    			</div>

			    <div class="form-group">
        			<label class="control-label col-xs-3 titi" for="fef1">Hasta :</label>
                    <div class="col-xs-5">
        			<input type="date" class="form-control" id="fef1" name="fef1" required placeholder="Fecha Final">
                    </div>
    			</div>

                
			    <div class="form-group">
        			<label class="control-label col-xs-3 titi" for="pre1">Importe Total :</label>
                    <div class="col-xs-5">
			    ...
			    <div class="form-group">
        			<label class="control-label col-xs-3 titi" for="ac1">A Cuenta :</label>
                    <div class="col-xs-5">
        			<input type="text" class="form-control" id="ac1" name="ac1" required placeholder="A Cuenta">
                    </div>
    			</div>
                    		...
                    		<div class="form-group">
  								<label  class="control-label col-xs-3 titi" for="observ1">Observaciones:</label>
                		    	<div class="col-xs-9">
 				 					<textarea class="form-control" rows="3" id="observ1" required name="observ1" placeholder="Observaciones"></textarea>
                     			</div>
							</div>                
