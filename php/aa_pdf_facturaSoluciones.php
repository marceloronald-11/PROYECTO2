...
$html .= '<tr><td width="20%"><img src="../recursos/computadoras.jpg" alt="raul.webnet" width="140px" height="70px"/></td>
...
$html .= '<table  border="0"  WIDTH="100%" >';
$html .= '<tr><td width="70%" class="fa6" ><h2>FACTURA</h2></td><td align="left" class="fa5">VENTA AL POR MENOR DE EQUIPOS DE OFICINA, LIBROS, PERIODICOS, Y PAPELERIA Y EQUIPO FOTOGRAFICO, OPTICO Y DE PRECISION</td></tr>'; 
$html .= '</table>';
...
$html .= '<tr><td align="left"  width="45%" class="border3" >CODIGO DE CONTROL :'.$xcontrol.'&nbsp; &nbsp;&nbsp;&nbsp; FECHA LIMITE DE EMISION :'.$xfli.'</td><td rowspan="2" width="10%" ><img src='.$xqr.'  width="110" height="110"></td></tr>';
