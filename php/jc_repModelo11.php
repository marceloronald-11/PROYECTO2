...
<table class="table table-striped  table-bordered titi">
	...
	while($registro2 = mysqli_fetch_array($registro)){
        ...
        <td hidden><input name="nordenx" value="'.$id.'" /></td>
                            ...
                            <td align="center"><input name="canlle[]" value="'.$registro2['cantllego'].'" /></td> 
                            <td align="right"><input name="prezio[]" value="'.$registro2['preciodt'].'" /></td> 
                            <td align="right"><input name="nfactt[]" value="'.$registro2['nfactura'].'" /></td>                           
    ...
    echo '<tr><td colspan="8"><a href="jc_modelo11.php"><img src="../recursos/salida.png" data-toggle="tooltip" title="Retornar a Recetas"> SALIR</a></td></tr> ';    
echo '</table>
