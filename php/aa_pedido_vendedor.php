...
<script src="../js/myjavaVendedor.js"></script>
...
<center><h3>PEDIDOS VENDEDOR</h3></center>
</div> <!-- fin col-sm-2 -->
<div class="col-sm-4 hidden-xs" style="background-color:white;">
...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="z_vendedor.php">Menu</a>
    </div>
    ...
    <div class="panel panel-primary">
      <div class="panel-heading">
        <h4 class="panel-title">
          <a data-toggle="collapse" href="#collapse4">DETALLE DE PEDIDO</a>
        </h4>
      </div>
...
<div class="col-sm-6" style="background-color:white;"> 
  <div class="panel-group coli3">
    <div class="panel panel-success">
      <div class="panel-heading">
        <h4 class="panel-title">
          <a data-toggle="collapse" href="#collapse1"> ORDEN DE PEDIDO</a>
        </h4>
      </div>
      <div id="collapse1" class="panel-collapse collapse in">
        <div class="panel-body">
            ...
            <input type="hidden" readonly id="codclixx" name="codclixx" >
 ...
 <input type="hidden" readonly id="fpg" name="fpg" >
					</div>


            	     <div class="row">
              			<div class="col-md-8">
                  		<span class="help-block text-muted small-font" > Cliente</span>
                  		<input type="text" class="form-control input-sm coli2" id="clie" placeholder="Nombre Cliente" />
              			</div>
					</div>
        ...
        <div class="panel-footer"><button type="button" class="btn btn-success guardar-entradaPed" accesskey="g"> <span class="glyphicon glyphicon-save"></span> <u>G</u>rabar Pedido</button>
...
<div class="row-fluid"><!-- row bb --> 
 <div class="panel-group coli3">
    <div class="panel panel-danger">
      <div class="panel-heading">
        <h4 class="panel-title">
          <a data-toggle="collapse" href="#collapse2">DETALLE DEL PEDIDO</a>
        </h4>
      </div>
...
<div class="row-fluid"><!-- row bb --> 
 <div class="panel-group coli3">
    <div class="panel panel-info">
      <div class="panel-heading">
        <h4 class="panel-title">
          <a data-toggle="collapse" href="#collapse3">IMPRESION ORDENES DE PEDIDO</a>
        </h4>
      </div>
