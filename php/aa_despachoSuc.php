...
<script src="../js/myjavaDespa.js"></script>
...
<center><h4>DESPACHO DE TRANSFERENCIAS</h4></center>
</div> <!-- fin col-sm-2 -->
<div class="col-sm-4 hidden-xs" style="background-color:white;">
...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="z_almacen.php">Menu</a>
    </div>
...
<div class="registros" id="agrega-registros" style="width:100%;"></div>
   ...
   <!-- MODAL PARA EL REGISTRO DE PRODUCTOS-->
    <div class="modal fade" id="modalPedd" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-md">
          <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
              <h4 class="modal-title" id="myModalLabel"><b>Formulario Entrega</b></h4>
            </div>
            <form id="formulario" class="form-horizontal " onsubmit="return agregaRegistroPe();">
            <div class="modal-body">
                   	<input type="hidden" required readonly id="pro" name="pro"/>
                   	<input type="hidden" required readonly id="idorden" name="idorden"/>

     <div class="row">
         		<div class="col-md-6">
                  <span class="help-block text-muted small-font tipe" > Cliente</span>
                  <input type="text" class="form-control input-sm" name="descli" id="descli" placeholder="Nombre del Cliente"   />
              	</div>
...
?>
            <div class="modal-footer">
            	<input type="submit" value="Registrarxxxx" class="btn btn-success" id="reg"/>
                <input type="submit" value="Confirmar Entrega" class="btn btn-warning"  id="edi"/>
