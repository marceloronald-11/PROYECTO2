...
<html lang="en">
	<head>
       ...
       <!-- <script src="../js/script/jquery-3.3.1.min.js"></script>  -->      
        ...
        <script src="../js_raos/myjavaEnvios.js"></script>
<!-- Alertyfy -->
...
$paimprimircompra= $objProducto->getImprimirEnvio();
$gsuc = $objProducto->getSucursaladm();
    ...
    <div class="panel panel-primary">
      <div class="panel-heading">
        <h4 class="panel-title">
          <a data-toggle="collapse" href="#collapse4">DETALLE DE ARTICULOS</a>
        </h4>
      </div>
...
<input type="hidden" class="form-control"  id="feven" value='2023/01/01' >
  <div class="row">
    ...
    <!--<div class="form-group col-md-5">
      <label for="cant">Vencimiento</label>
      <input type="date" class="form-control"  id="feven" >
    </div>-->
  </div>
  ...
  <div class="row">
    ...
    <div class="form-group col-md-3">
      <label for="inputPassword4">Precio Neto</label>
  ...
  <button type="button" class="btn btn-primary btnAgrega" accesskey="a"><span class="glyphicon glyphicon-plus-sign"></span> <u>A</u>gregar Item</button>
...
<div class="col-sm-6" style="background-color:white;"> 
  <div class="panel-group coli3">
    <div class="panel panel-success">
      <div class="panel-heading">
        <h4 class="panel-title">
          <a data-toggle="collapse" href="#collapse1"> DATOS GENERALES</a>
        </h4>
      </div>
      <div id="collapse1" class="panel-collapse collapse in">
        <div class="panel-body">
			...
			<input type="hidden" readonly id="codpvx" name="codpvx" value="0">				
            	     ...
            	     <div class="row">
              			...
              			<div class="col-md-8">
                  		<span class="help-block text-muted small-font" >Encargado </span>
                  		<input type="text" autocomplete="off" class="form-control input-sm coli2" id="respo"  placeholder="Encargado" />
              			</div>
		...
		<div class="col-md-8">
          ...
          <select name="codsuc3" id="codsuc3" class="form-control" >
        ...
        <div class="panel-footer"><button type="button" class="btn btn-success guardar-envio" accesskey="g"> <span class="glyphicon glyphicon-save"></span> <u>G</u>rabar Nota</button>
...
<div class="row-fluid"><!-- row bb --> 
 <div class="panel-group coli3">
    <div class="panel panel-info">
      <div class="panel-heading">
        <h4 class="panel-title">
          <a data-toggle="collapse" href="#collapse3">IMPRESION DE COMPRAS</a>
        </h4>
      </div>
      <div id="collapse3" class="panel-collapse collapse table-responsive">
        <div class="panel-body">
					<table class="table titi" width="100%">
					    ...
					    <tbody>
					    	<?php 
					    	foreach($paimprimircompra as $dett2){ 
