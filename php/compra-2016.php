...
<div class="row arriba">
	 <header>MODULO DE COMPRAS</header>
</div>
<div class="row medio">
...
<div class="panel panel-info col-md-6">
			 <div class="panel-heading">
		        <h1 class="panel-title">GENERANDO COMPRAS...</h1><br>
                <button type="button" class="btn btn-sm btn-warning irmodal"><span class="glyphicon glyphicon-check"></span> CERRAR COMPRA</button>
                <button type="button" class="btn btn-sm btn-danger limpiacarro"><span class="glyphicon glyphicon-remove"></span> CANCELAR COMPRA</button>
		      </div>
