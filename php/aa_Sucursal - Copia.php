...
<div class="registros table-responsive" id="agrega-registros" style="width:100%;"></div>
    ...
    <div class="modal fade" id="registra-artis" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
     ...
     <div class="row">
         		<div class="col-md-5">
                  <span class="help-block text-muted small-font tipe" > Sucursal:</span>
                  <input type="text" class="form-control input-sm" name="dessuc" id="dessuc" placeholder="Sucursal"   />
              	</div>
         		<div class="col-md-5">
                  <span class="help-block text-muted small-font tipe" > Direccion:</span>
                  <input type="text" class="form-control input-sm" name="dirsuc" id="dirsuc" placeholder="Direccion"   />
              	</div>
