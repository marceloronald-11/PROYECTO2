...
$fecha = date('Y-m-d');
    ...
    $nroProductos = mysqli_num_rows(mysqli_query($conexion,"SELECT * FROM movimtot WHERE tmm='Ventas' AND codsuc='$codsucx' "));
    $nroLotes = 10;
    ...
    if($paginaActual < $nroPaginas){
  	...
  	$registro = mysqli_query($conexion,"SELECT * FROM movimtot WHERE tmm='Ventas' AND codsuc='$codsucx'  LIMIT $limit, $nroLotes ");
