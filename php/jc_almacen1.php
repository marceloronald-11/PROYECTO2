...
-->
		...
		<!-- java personal -->
        <script src="../js_raos/myjavaAlm1.js"></script>
	...
	<body class="no-skin">
				...
				<div class="navbar-buttons navbar-header pull-right" role="navigation">
					...
					<li class="grey dropdown-modal">
							<a data-toggle="dropdown" class="dropdown-toggle" href="#">
								...
								<span class="badge badge-black"><?php echo $nroMae ?></span>
							</a>
					</li>
		...
		<div class="main-container ace-save-state" id="main-container">
			...
			<div class="main-content">
				...
				<tr><td >Nombre :</td><td><input type="text" class="form-control" id="nomb" name="nomb" required placeholder="Nombre"></td>
				...
				<td>Cargo :</td><td><input type="text" class="form-control" id="carg" name="carg" required placeholder="Cargo "></td>
											...
											<!-- <button class="btn btn-white btn-info btn-bold" id="nuevoCritico">
												<i class="ace-icon fa fa-folder-open-o bigger-50 blue"></i>
												GENERAR STOCK-CRITICO
											</button> -->
											<button class="btn btn-white btn-info btn-bold" id="nuevoCriticoo">
												<i class="ace-icon fa fa-folder-open-o bigger-50 blue"></i>
												GENERAR STOCK-CRITICO
											</button>											
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
					 <input type="hidden"   id="idrep" name="idrep" />
					   ...
					   <input type="hidden" class="form-control input-sm" id="npar" name="npar" />					   
