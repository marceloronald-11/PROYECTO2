...
<td WIDTH="35%" class="fa1" >DISTRIBUIDORA VALEN <br>Cale Beni y Pando No 18 Zona Norte-Terminal de Buses - Cel.: 77586387
<br> BOLIVIA</td><td  class="border" width="25%"><p class="fa2">No Orden :'.$nordenx.'</p></td></tr>';
$html .= '</table>';
//
$html .= '<table  border="0"  WIDTH="100%" >';
$html .= '<tr><td width="70%" class="fa6"><h2>NOTA DE PEDIDO</h2></td><td align="left" class="fa5">VENTA AL POR MAYOR Y MENOR CALIDAD GARANTIZADA</td></tr>'; 
$html .= '</table>';
//
//
