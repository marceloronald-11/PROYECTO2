...
-->
		...
		<!-- java personal -->
        <script src="../js_raos/myjavaSupervi.js"></script>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title" id="myModalLabel"><b>SUPERVISOR FORM.</b></h4>
            </div>
            <form id="formulario" class="form-horizontal " onsubmit="return agregaRegistroSpv();">
            <div class="modal-body">
			    ...
			    <div class="form-group">
        			<label class="control-label col-xs-3 titi" for="nomspv">Detalle :</label>
                    <div class="col-xs-9">
        			<input type="text" class="form-control" id="nomspv" name="nomspv" required placeholder="Detalle ">
                    </div>
    			</div>
			    <div class="form-group">
        			<label class="control-label col-xs-3 titi" for="cospv">Codigo :</label>
                    <div class="col-xs-4">
        			<input type="text" class="form-control" id="cospv" name="cospv" required placeholder="Codigo ">
                    </div>
    			</div>
