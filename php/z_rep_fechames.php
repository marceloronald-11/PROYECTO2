...
$registro = mysqli_query($conexion,"SELECT * FROM pagosgym AS mv JOIN clientes AS cli ON mv.idcli=cli.idcli WHERE fechapg BETWEEN '$desde' AND '$hasta'");
...
if(mysqli_num_rows($registro)>0){
	...
	echo '<tr><td colspan="5"></td><td> Total Bs.- </td><td align="right">'.number_format($ttot,2).'</td><tr>';
}else{
	echo '<tr>
