...
-->
		...
		<!-- java personal -->
        <script src="../js_raos/myjavaTsopor.js"></script>
					...
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							<li>
								...
								<a href="crm_soporte.php">Inicio</a>
							</li>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title" id="myModalLabel"><b>FORMULARIO SOPORTE</b></h4>
            </div>
            <form id="formulario" class="form-horizontal " onsubmit="return agregaRegistroSopo();">
            <div class="modal-body">
			    ...
			    <div class="form-group">
        			<label class="control-label col-xs-3 titi" for="nomar">Area :</label>
                    <div class="col-xs-9">
        			<input type="text" class="form-control" id="nomar" name="nomar" required placeholder="Area ">
                    </div>
    			</div>
            ...
            <div class="modal-footer">
                ...
                <input type="submit" value="ATENCION CONFIRMADA" class="btn btn-warning"  id="edi"/>
