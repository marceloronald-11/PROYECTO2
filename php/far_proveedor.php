...
-->
		...
		<!-- java personal -->
        <script src="../js_raos/myjavaProveedor.js"></script>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
			    ...
			    <div class="form-group">
        			<label class="control-label col-xs-3 titi" for="nomlab">Proveedor :</label>
                    <div class="col-xs-9">
        			<input type="text" class="form-control" id="nomlab" name="nomlab" required placeholder="Proveedor">
                    </div>
    			</div>
