...
-->
		...
		<!-- java personal -->
        <script src="../js_raos/myjavaProf.js"></script>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title" id="myModalLabel"><b>PROFESIONES FORM.</b></h4>
            </div>
            <form id="formulario" class="form-horizontal " onsubmit="return agregaRegistroProf();">
            <div class="modal-body">
			    ...
			    <div class="form-group">
        			<label class="control-label col-xs-3 titi" for="nomprof">Detalle :</label>
                    <div class="col-xs-9">
        			<input type="text" class="form-control" id="nomprof" name="nomprof" required placeholder="Detalle ">
                    </div>
    			</div>
			    <div class="form-group">
        			<label class="control-label col-xs-3 titi" for="coprof">Codigo :</label>
                    <div class="col-xs-4">
        			<input type="text" class="form-control" id="coprof" name="coprof" required placeholder="Codigo ">
                    </div>
    			</div>
