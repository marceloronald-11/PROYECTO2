...
<html lang="en">
	<head>
       ...
       <!-- <script src="../js/script/jquery-3.3.1.min.js"></script>  -->      
        ...
        <script src="../js_raos/myjavaComprasfac.js"></script>
<!-- Alertyfy -->
...
$paimprimircompra= $objProducto->getImprimirVta11();
...
-->             
 <input type="hidden" class="form-control" id="idcodx" />
  ...
  <div class="row">
    ...
    <div class="form-group col-md-3">
      <label for="inputPassword4">Costo Unitario</label>
  ...
  <div class="panel-group coli3">
    <div class="panel panel-success">
      ...
      <div id="collapse1" class="panel-collapse collapse in">
        <div class="panel-body">
			...
			<input type="hidden" readonly id="codpvx" name="codpvx" value="0">				
            	     ...
            	     <div class="row">
                  		...
                  		<input type="text" autocomplete="off" class="form-control input-sm coli2" id="respo" value="<?php echo $nombre_u;?>"   placeholder="Encargado" />
              			</div>
        				...
        				<div class="col-md-8">
                  		...
                  		<select name="cpv" id="cpv" class="form-control" >
							 <option value="0">Ninguno</option>
								<?php foreach($provee as $dato1):?>
							<option value="<?php echo $dato1['codpv']?>"><?php echo $dato1['nombrepv']?></option>
								<?php endforeach;?>
						</select>
        ...
        <div class="panel-footer"><button type="button" class="btn btn-success guardar-compra" accesskey="g"> <span class="glyphicon glyphicon-save"></span> <u>G</u>rabar Nota</button>
