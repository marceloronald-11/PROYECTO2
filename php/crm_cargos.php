...
-->
		...
		<!-- java personal -->
        <script src="../js_raos/myjavaCargocr.js"></script>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title" id="myModalLabel"><b>FORMULARIO CARGOS</b></h4>
            </div>
            <form id="formulario" class="form-horizontal " onsubmit="return agregaRegistroCargo();">
            <div class="modal-body">
			    ...
			    <div class="form-group">
        			<label class="control-label col-xs-3 titi" for="nomar">Cargo :</label>
                    <div class="col-xs-9">
        			<input type="text" class="form-control" id="nomar" name="nomar" required placeholder="Cargo ">
                    </div>
    			</div>
