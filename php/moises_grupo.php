...
-->
		...
		<!-- java personal -->
        <script src="../js_raos/myjavaGrupomoi.js"></script>
        ...
        <div class="modal-dialog modal-md">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title" id="myModalLabel"><b>FORM.GRUPO</b></h4>
            </div>
            <form id="formulario" class="form-horizontal " onsubmit="return agregaRegistrocla();">
            <div class="modal-body">
					 <input type="hidden"   id="idgru" name="idgru" />
                   	<input type="hidden" required readonly id="pro" name="pro"/>


			    <div class="form-group">
        			<label class="control-label col-xs-3 titi" for="grupof">Grupo :</label>
                    <div class="col-xs-9">
        			<input type="text" class="form-control" id="grupof" name="grupof" required placeholder="Grupo  ">
                    </div>
    			</div>
