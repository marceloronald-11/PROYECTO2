...
mysqli_query($conexion,"UPDATE productos SET foto = '$destino' WHERE id_prod = '$id'");

	echo '<Script language=javascript> 
	alert("LA IMAGEN DEL ARTICULO  FUE SUBIDA CORRECTAMENTE...")
	self:location="articulo.php"	
	</script>';
 ?>
