...
<script src="../js/myjava_rc.js"></script>
	<meta name="viewport" content="width=device-width, user-scalable=no, initial-scale=1.0, maximum-scale=1.0, minimum-scale=1.0">
    <link rel="stylesheet" href="../bootstrap/css/bootstrap.min.css">
</head>
<body>
    <header>BUSQUEDA DE PROVEEDORES COMPRAS</header>
   <div class="container"> 
    	<div class=" main row">
    ...
    <table border="0" align="center">
    	<tr>
        	<td width="335">Filtrar:<input type="text" placeholder="Buscar por nombre del Proveedor" id="bs-prod"/></td>
