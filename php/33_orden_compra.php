...
<script src="../js/33_java_ocompra.js"></script>
...
$paimprimir = $objProducto->getImprimirOrden();

$nnota = $objProducto->getcodnu();
		foreach($nnota as $nro):
			$nroing= $nro['nordenvar']+1;
		endforeach;
...
<br>
<div class="row titulo" style="background-color:#a3b5d6; color:#070707; "> 
		<div class="col-md-2" >
		...
		<div class="col-md-6">
            	<table class="table">
                <tr><td align="center"><h3>ORDEN DE COMPRAS</h3></td>
               </tr>
                </table>
		</div>
...
<div class="row" > 
		...
		<center><h4>FORMULARIO DE COMPRAS</h4></center>
...
<input type="hidden" class="form-control input-sm" id="cla" placeholder="cod clase"  />
     			...
     			<div class="row">
      			...
      			<div class="row">
         			...
         			<div class="col-md-3">
                  	<span class="help-block text-muted small-font" >P.Neto :</span>
                 	 <input type="text" class="form-control input-sm" id="pn" placeholder="P.Neto"   />
              		</div>
...
<button type="button" class="btn btn-sm  btn-danger LimpiaForm" accesskey="a"><span class="glyphicon glyphicon-remove-sign"></span> <u>L</u>impiar Formulario</button>
		...
		<div class="col-md-5 fila2" style="background-color:#fcf8f8;"> <!--B inicio DE col-md-5 -->
				<center><h4>Nota :Orden Compra</h4></center>
...
<div class="row"> <!--inicio row D -->
		<div class="col-md-12 fila3">
            ...
            <div class="detalle-producto1" style="background-color:#a3b5d6; color:#040007;"> 
<br>
