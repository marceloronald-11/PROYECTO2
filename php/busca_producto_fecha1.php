...
$registro=mysql_query("SELECT * FROM venta INNER JOIN venta_detalle ON venta_detalle.id = venta.id WHERE fecha_reg BETWEEN '$desde' AND '$hasta' ORDER BY id ASC");
