...
-->
		...
		<!-- java personal -->
        <script src="../js_raos/myjavaComision.js"></script>
					...
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						...
						<div class="nav-search" id="nav-search">
							<form class="form-search">
								<input type="hidden"  class="nav-search-input" id="id_usux"/>
								
								<input type="date"  class="nav-search-input fei" id="nav-search-inputx"/>								
								
								<input type="date"  class="nav-search-input fef" id="nav-search-inputxx"/>
								
								
								<span class="input-icon">
									<input type="text" placeholder="Usuario ..." class="nav-search-input" id="vendedor" autocomplete="off" />
									<i class="ace-icon fa fa-search nav-search-icon buscacomi"></i>
								</span>
							</form>
						</div><!-- /.nav-search -->
					</div>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
			    ...
			    <div class="form-group">
        			<label class="control-label col-xs-3 titi" for="nomsalon">Nombre del salon:</label>
                    <div class="col-xs-9">
        			<input type="text" class="form-control" id="nomsalon" name="nomsalon" required placeholder="Nombre del Salon ">
                    </div>
    			</div>
			    <div class="form-group">
        			<label class="control-label col-xs-3 titi" for="nomsalon">Propietaria:</label>
                    <div class="col-xs-4">
        			<input type="radio"  name="mvv" CHECKED id="SII" value="SI">SI
					<input type="radio"  name="mvv"  id="NOO" value="NO"> NO
			    ...
			    <div class="form-group">
                    ...
                    <div class="col-xs-6">
        			<input type="text" class="form-control" id="telcli" name="telcli" required placeholder="Telefono o Celular ">
                    </div>
    			</div>
