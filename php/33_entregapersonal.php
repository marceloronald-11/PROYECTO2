...
<script src="../js/33_java_perso.js"></script>
...
<div class="row titulo" style="background-color:#ab8cc8; color:#070707; "> 
		...
		<div class="col-md-6">
            	<table class="table"><tr><td align="center"><h3>Modulo: ENTREGA DE ARTICULOS</h3></td></tr></table>
		</div>
...
<tr> <td align="right">Responsable:</td><td><input type="text" class="form-control" id="encarga" placeholder="Encargado"></td></tr>
</table>
