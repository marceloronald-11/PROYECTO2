...
switch($proceso){
	...
	case 'Edicion':
		...
		mysqli_query($conexion,"UPDATE transfertot SET cdpedd ='X' WHERE norden = '$idorden'");
...
//ACTUALIZAMOS LOS REGISTROS Y LOS OBTENEMOS
	$registro= mysqli_query($conexion,"SELECT * FROM transfertot WHERE cdpedd='' ORDER BY norden DESC");
