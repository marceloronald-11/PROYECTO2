...
<script src="../js/myjavaProvv.js"></script>
...
<center><h4>MODULO DE PROVEEDORES</h4></center>
</div> <!-- fin col-sm-2 -->
<div class="col-sm-4 hidden-xs" style="background-color:white;">
    ...
    <div class="modal fade" id="registra-artis" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title" id="myModalLabel"><b>Registro/Edicion Proveedor</b></h4>
            </div>
            <form id="formulario" class="form-horizontal " onsubmit="return agregaRegistroPv();">
     ...
     <div class="row">
         		<div class="col-md-4">
                  ...
                  <input type="text" class="form-control input-sm" name="despv" id="despv" placeholder="Proveedor"   />
              	</div>
         		<div class="col-md-4">
     ...
     <div class="row">
         		<div class="col-md-6">
                  <span class="help-block text-muted small-font tipe" >  Observaciones:</span>
 					<textarea class="form-control" rows="3" id="observv"  name="observv" placeholder="Observaciones"></textarea>
              	</div>
      </div>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-header">
					...
					<h4 class="modal-title">IMAGEN PROVEEDOR</h4>
				</div>
				<!--header cuerpo -->
...
<div class="modal fade" id="modalcargafoto" data-backdrop="static", data-keyboard="true">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-header">
						<button class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
					<h4 class="modal-title">PROVEEDOR IMAGEN</h4>
				</div>
				<!--header cuerpo -->
