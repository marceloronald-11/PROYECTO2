...
//$codsucx=$_SESSION['codsuc'];
    ...
    $nroProductos = mysqli_num_rows(mysqli_query($conexion,"SELECT * FROM articulos AS ar LEFT JOIN proveedor AS pv ON ar.codpv=pv.codpv "));
  // $nroProductos = mysqli_num_rows(mysqli_query($conexion,"SELECT * FROM articulos "));
    ...
    if($paginaActual < $nroPaginas){
 	...
 	$registro = mysqli_query($conexion,"SELECT * FROM articulos AS ar LEFT JOIN proveedor AS pv ON ar.codpv=pv.codpv  LIMIT $limit, $nroLotes ");
