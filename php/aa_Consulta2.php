...
<script src="../js/myjavaConsul1.js"></script>
...
<center><h4>CONSULTAS SUCURSALES</h4></center>
</div> <!-- fin col-sm-2 -->
...
<!--      <div class="input-group">
        <input type="date" class="form-control" id="fei"   placeholder="Desde">
      </div>

      <div class="input-group">
        <input type="date" class="form-control" id="fef"  placeholder="Hasta">
      </div>
-->      
