...
-->
		...
		<!-- java personal -->
        <script src="../js_raos/myjavaPedidogral.js"></script>
				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS ///////////////////////////////////////////////////////////// -->
											<button class="btn btn-white btn-info btn-bold" id="genera">
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title" id="myModalLabel"><b>FORM.ZONAS</b></h4>
            </div>
            ...
            <div class="modal-body">
			    ...
			    <div class="form-group">
        			<label class="control-label col-xs-3 titi" for="descla">Zona :</label>
                    <div class="col-xs-9">
        			<input type="text" class="form-control" id="descla" name="descla" required autocomplete="off" placeholder="Zona ">
                    </div>
    			</div>
