...
$totcuota=$registro2['capital']+$registro2['interes']+$registro2['cargos']+$registro2['garantia'];	
	...
	if($pago!='SI'){
							echo'<td align="center"><a href="javascript:editarPlanCuotaxx('.$registro2['codplan'].');" ><img src="../recursos/caja.png" data-toggle="tooltip" title="PAGAR CUOTA "></a></td>';
	}else{
...
echo '<tr><td colspan="4"><a href="crm_DetallePrestamo.php"><img src="../recursos/salida.png" data-toggle="tooltip" title="Retornar "> SALIR</a></td></tr>'.'  ';
echo '</table>';
?>