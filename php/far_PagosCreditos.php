        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
					 ...
					 <input type="hidden"   id="colabx" name="colabx" />
			    ...
			    <div class="form-group">
        			<label class="control-label col-xs-3 titi" for="pass">Laboratorio :</label>
                    <div class="col-xs-7">
        			<input type="text" class="form-control" readonly id="nomlab" name="nomlab" required placeholder="Laboratorio">
                    </div>
    			</div>
