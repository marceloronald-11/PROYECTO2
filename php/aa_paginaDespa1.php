...
$codsucx=$_SESSION['codsuc'];
    ...
    $nroProductos = mysqli_num_rows(mysqli_query($conexion,"SELECT * FROM movimtot WHERE tipo='E' AND cdpedd='' ORDER BY norden DESC")); // falta codsuc='$codsucx'
    $nroLotes = 10;
...
$registro= mysqli_query($conexion,"SELECT * FROM movimtot WHERE tipo='E' AND cdpedd='' ORDER BY norden DESC LIMIT $limit, $nroLotes");
