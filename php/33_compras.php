...
$paimprimir = $objProducto->getImprimirInventario();
...
<br>
<div class="row titulo" style="background-color:#b2dbdd; color:#070707; "> 
		<div class="col-md-2" >
		...
		<div class="col-md-6">
            	<table class="table"><tr><td align="center"><h3>Modulo: COMPRAS INVENTARIOS</h3></td></tr></table>
		</div>
...
<div class="row" > 
		...
		<center><h4>FORMULARIO DE REGISTRO</h4></center>
                              ...
                              <input type="hidden" required readonly id="iidper" name="iidepr"/>

<table border="0" width="80%" class="table">
<tr> <td align="right">No Nota :</td><td width="50%"><input type="text" class="form-control" readonly id="nnota" name="nnota" value="<?php echo $nroing;?>" placeholder="Nro Recibo"></td>
<td align="right">Factura</td><td><input type="text"   class="form-control" id="fac" ></td></tr>
...
<tr> <td align="right">Encargado:</td><td><input type="text" class="form-control" id="encarga" placeholder="Encargado"></td></tr>
        	 ...
        	 <form  class="form-horizontal" id="formulario">
              <input type="hidden"  id="idusu" name="idusu" value="<?php echo $id_usu;?>" >
			      	...
			      	<!--<input type="text"  id="codar" name="codar"/>-->
...
<div><button type="button" class="btn btn-sm  btn-primary btnTecnico" accesskey="a"><span class="glyphicon glyphicon-plus-sign"></span> <u>A</u>GREGAR ITEM</button>
...
<tr><td align="center"><button type="button" class="btn btn-success guardaring btn-sm" accesskey="g"><span class="glyphicon glyphicon-floppy-save"></span> <u>G</u>RABAR NOTA</button></td></tr>
...
<div class="row"> <!--inicio row D -->
		<div class="col-md-12 fila3">
            ...
            <div class="detalle-producto1" style="background-color:#b2dbdd; color:#040007;"> 
<br>
