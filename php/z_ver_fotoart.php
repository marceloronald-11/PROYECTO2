...
<tr><td width="150" ><?php echo $f['descripcion']; ?></td></tr>
<tr><td width="150"><?php	echo '<img src="'.$f['foto'].'" width="200" heigth="200"/>';?></td></tr>
<?php } ?>
</table>

<form action="z_subirart.php" method="post" id="formulario" enctype="multipart/form-data">
