...
-->
		...
		<!-- java personal -->
        <script src="../js_raos/myjavaLaborato.js"></script>
    ...
    <div class="modal fade" id="labo-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <form id="formulario" class="form-horizontal " onsubmit="return agregaRegistrolab();">
            <div class="modal-body">
			    ...
			    <div class="form-group">
        			<label class="control-label col-xs-3 titi" for="nomlab">Laboratorio :</label>
                    <div class="col-xs-9">
        			<input type="text" class="form-control" id="nomlab" name="nomlab" required placeholder="Laboratorio ">
                    </div>
    			</div>


			    <div class="form-group">
        			<label class="control-label col-xs-3 titi" for="dirlab">Direccion :</label>
                    <div class="col-xs-9">
        			<input type="text" class="form-control" id="dirlab" name="dirlab" required placeholder="Direccion">
                    </div>
    			</div>
			    ...
			    <div class="form-group">
        			<label class="control-label col-xs-3 titi" for="maillab">Correo :</label>
                    <div class="col-xs-9">
        			<input type="text" class="form-control" id="maillab" name="maillab"  placeholder="Correo Electronico">
                    </div>
    			</div>

                <div class="form-group">
                <label  class="control-label col-xs-3 titi" for="oblab">Observaciones:</label>
                <div class="col-xs-9">
                <textarea class="form-control" rows="3" id="oblab"  name="oblab" placeholder="Observaciones"></textarea>
                </div>
                </div>                
