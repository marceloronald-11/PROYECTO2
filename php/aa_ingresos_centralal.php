...
<center><h3>COMPRAS ALMACEN</h3></center>
</div> <!-- fin col-sm-2 -->
<div class="col-sm-4 hidden-xs" style="background-color:white;">
    ...
    <div class="panel panel-primary">
      <div class="panel-heading">
        <h4 class="panel-title">
          <a data-toggle="collapse" href="#collapse4">DETALLE DE COMPRAS</a>
        </h4>
      </div>
...
<div class="col-sm-6" style="background-color:white;"> 
  <div class="panel-group coli3">
    <div class="panel panel-success">
      <div class="panel-heading">
        <h4 class="panel-title">
          <a data-toggle="collapse" href="#collapse1"> ORDEN DE COMPRA</a>
        </h4>
      </div>
        ...
        <div class="panel-body">
            ...
            <input type="hidden" readonly id="idusu" name="idusu" value="<?php echo $id_usu;?>">
            	     ...
            	     <div class="row">
              			...
              			<div class="col-md-4">
                  		<span class="help-block text-muted small-font" > Tipo Movimiento</span>
...
-->                                </select>
        ...
        <div class="panel-footer"><button type="button" class="btn btn-success guardar-entrada" accesskey="g"> <span class="glyphicon glyphicon-save"></span> <u>G</u>rabar Nota</button>
...
<div class="row-fluid"><!-- row bb --> 
 <div class="panel-group coli3">
    <div class="panel panel-info">
      <div class="panel-heading">
        <h4 class="panel-title">
          <a data-toggle="collapse" href="#collapse3">IMPRESION ORDENES DE COMPRA</a>
        </h4>
      </div>
