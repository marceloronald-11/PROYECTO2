...
$paimprimirvta= $objProducto->getImprimirvvta();
...
<script src="../js/myjavaComm.js"></script>
 ...
 <input type="hidden" class="form-control" id="idcodx" />
     			...
     			<div class="row">
                 	...
                 	<div class="col-md-3">
                 	 ...
                 	 <input type="text" class="form-control input-md coli2" id="pneto"  placeholder="Precio"   />
              		</div>
    ...
    <div class="panel panel-success">
      ...
      <div id="collapse1" class="panel-collapse collapse in">
        <div class="panel-body">
			...
			<input type="hidden" class="form-control input-sm coli2" id="nitv"  />                           
...
<div class="row-fluid"><!-- row bb --> 
 <div class="panel-group coli3">
    <div class="panel panel-danger">
      <div class="panel-heading">
        <h4 class="panel-title">
          <a data-toggle="collapse" href="#collapse2">PRE-VISUALIZACION DE LA NOTA</a>
        </h4>
      </div>
...
<div class="row-fluid"><!-- row bb --> 
 <div class="panel-group coli3">
    <div class="panel panel-info">
      <div class="panel-heading">
        <h4 class="panel-title">
          <a data-toggle="collapse" href="#collapse3">IMPRESION DE NOTAS DE COMPRA</a>
        </h4>
      </div>
	...
	<td align="center" width="5%"><a href="javascript:mostrarCompras(<?php echo $dett2['norden']; ?>)"><img src="../recursos/impresora.png" data-toggle="tooltip" title="Impresion de Nota"></a></td>                               
					        </tr>
					        <?php }?>
					    </tbody>
					</table>
