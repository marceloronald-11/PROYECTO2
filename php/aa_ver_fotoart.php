...
<?php
$re=mysqli_query($conexion,"select * FROM articuloss WHERE codar=$id");

while($f=mysqli_fetch_array($re)){ ?>

<tr><td width="150" ><?php echo $f['descripart']; ?></td></tr>
<tr><td width="150"><?php	echo '<img src="'.$f['fotoar'].'" width="200" heigth="200"/>';?></td></tr>
<?php } ?>
</table>

<form action="aa_subirart.php" method="post" id="formulario" enctype="multipart/form-data">
