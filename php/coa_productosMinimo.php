...
-->
		...
		<!-- java personal -->
        <script src="../js_raos/myjavaCoaProductosMin.js"></script>
...
<input type="hidden"   id="marcax" name="marcax" >
<input type="hidden"   id="modelox" name="modelox" >
<input type="hidden"   id="procex" name="procex" >
<input type="hidden"   id="prov" name="prov" value="0">
			    ...
			    <div class="form-group">
        			<label class="control-label col-xs-3 titi" for="cla">Clasificacion :</label>
                    <div class="col-xs-6">
  				...
  				<div class="form-group">
        			<label class="control-label col-xs-3 titi" for="pvp">Costo Unitario:</label>
                    <div class="col-xs-4">
