...
-->
		...
		<!-- java personal -->
        <script src="../js_raos/myjavaAprobar1.js"></script>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title" id="myModalLabel"><b>FORMULARIO APROBACION</b></h4>
            </div>
            <form id="formulario" class="form-horizontal " onsubmit="return agregaRegistroApro();">
            <div class="modal-body">
			    ...
			    <div class="form-group">
        			<label class="control-label col-xs-3 titi" for="nomar">Cliente :</label>
                    <div class="col-xs-9">
        			<input type="text" class="form-control" id="nomar" name="nomar" required placeholder="cliente ">
                    </div>
    			</div>
            ...
            <div class="modal-footer">
                ...
                <input type="submit" value="Aprobar" class="btn btn-warning"  id="edi"/>
