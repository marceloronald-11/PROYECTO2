...
-->
		...
		<!-- java personal -->
        <script src="../js_raos/myjavaTipo.js"></script>
        ...
        <div class="modal-dialog modal-md">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title" id="myModalLabel"><b>FORM.TIPO</b></h4>
            </div>
            <form id="formulario" class="form-horizontal " onsubmit="return agregaRegistrotipo();">
            <div class="modal-body">
			    ...
			    <div class="form-group">
        			<label class="control-label col-xs-3 titi" for="tipof">Tipo :</label>
                    <div class="col-xs-9">
        			<input type="text" class="form-control" id="tipof" name="tipof" required placeholder="Marca  ">
                    </div>
    			</div>
