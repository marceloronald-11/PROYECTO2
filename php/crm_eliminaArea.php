...
mysqli_query($conexion,"DELETE FROM cursoalumno WHERE codarea = '$cdarea'");

mysqli_query($conexion,"UPDATE alumno SET nareas=nareas-1  WHERE codalum = '$cdcli'");
////UPDATE nro AREAS


//ACTUALIZAMOS LOS REGISTROS Y LOS OBTENEMOS

$registro = mysqli_query($conexion,"SELECT * FROM areaalumno WHERE codalum='$cdcli' ");
