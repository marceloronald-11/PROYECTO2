...
echo '<table class="table table-striped table-condensed table-hover titi">
	...
	while($registro2 = mysqli_fetch_array($registro)){
		echo '<tr>
							...
							<td align="center"><a href="javascript:editarCliee('.$registro2['id_per'].');" ><img src="../recursos/lapiz.png" data-toggle="tooltip" title="Editar Registro"></a>
							 <a href="javascript:eliminarCliee('.$registro2['id_per'].');" ><img src="../recursos/borrar.png" data-toggle="tooltip" title="Eliminar Registro"></a>
