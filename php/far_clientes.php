...
-->
		...
		<!-- java personal -->
        <script src="../js_raos/far_myjavaCliente.js"></script>
...
<ul class="nav nav-list">
				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS ///////////////////////////////////////////////////////////// -->
											<button class="btn btn-white btn-info btn-bold" id="nuevo-cliente">
    ...
    <div class="modal fade" id="cliente-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
			    ...
			    <div class="form-group">
        			<label class="control-label col-xs-3 titi" for="nomcli">Nombre Cliente :</label>
                    <div class="col-xs-9">
        			<input type="text" class="form-control" id="nomcli" name="nomcli" required placeholder="Nombre Cliente ">
                    </div>
    			</div>
			    ...
			    <div class="form-group">
        			<label class="control-label col-xs-3 titi" for="Telf">Telf/Celular :</label>
                    <div class="col-xs-9">
        			<input type="text" class="form-control" id="telf" name="telf" required placeholder="Telefono">
                    </div>
    			</div>
			    <div class="form-group">
        			<label class="control-label col-xs-3 titi" for="mailcli">Correo :</label>
                    <div class="col-xs-9">
        			<input type="text" class="form-control" id="mailcli" name="mailcli"  placeholder="Correo Electronico">
                    </div>
    			</div>

			    <div class="form-group">
        			<label class="control-label col-xs-3 titi" for="nitc">Nit Cliente :</label>
                    <div class="col-xs-9">
        			<input type="text" class="form-control" id="nitc" name="nitc"  placeholder="Nit Cliente">
                    </div>
    			</div>

                <div class="form-group">
                <label  class="control-label col-xs-3 titi" for="obcli">Observaciones:</label>
                <div class="col-xs-9">
                <textarea class="form-control" rows="3" id="obcli"  name="obcli" placeholder="Observaciones"></textarea>
                </div>
                </div>                
