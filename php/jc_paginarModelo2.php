<?php
	...
	while($registro2 = mysqli_fetch_array($registro)){
        ...
        $tabla = $tabla.'<tr>
                            ...
                            if($op1=='Proceso'){
                             $tabla = $tabla.'<td align="center"><a href="javascript:versolCompra('.$registro2['norden'].');" ><img src="../recursos/lapiz.png" data-toggle="tooltip" title="Ver Nota "></a> <a href="javascript:Imprii('.$registro2['norden'].');" ><img src="../recursos/impresora.png" data-toggle="tooltip" title="Imprimir "></a>
							</td>';
                            }else{
