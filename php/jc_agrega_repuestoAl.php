...
switch($proceso){
	...
	case 'Editar':
       // mysqli_query($conexion,"UPDATE repuesto SET detrepuesto='$nomm',umed='$umd',nparte='$npar',ubicacion='$ubi',especificacion='$espe',costo='$cossto',saldo='$sal',saldomin='$salcr' WHERE codrep = '$idrepx'");
        
        mysqli_query($conexion,"UPDATE repuesto SET saldomin='$salcr',ubicacion='$ubi' WHERE codrep = '$idrepx'");
