...
$idperx=$_SESSION['id_per'];
	...
	ar.codpv=pv.codpv JOIN clasificacion AS cl ON ar.codcla=cl.codcla  WHERE ar.codven='$idperx' "));
    $nroLotes = 10;
	...
	ar.codpv=pv.codpv JOIN clasificacion AS cl ON ar.codcla=cl.codcla  WHERE ar.codven='$idperx' LIMIT $limit, $nroLotes ");
	...
	while($registro2 = mysqli_fetch_array($registro)){
		$tabla = $tabla.'<tr>
							...
							$tabla = $tabla.'<a href="javascript:VerKardex('.$registro2['codar'].');" ><img src="../recursos/factura.png" data-toggle="tooltip" title="Ver Kardex"></a> 
