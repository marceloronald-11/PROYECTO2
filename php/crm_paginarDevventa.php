<?php
    ...
    $nroProductos = mysqli_num_rows(mysqli_query($conexion,"SELECT * FROM movimtot WHERE tipo='E'"));
    $nroLotes = 10;
    ...
    if($paginaActual < $nroPaginas){
  	...
  	$registro = mysqli_query($conexion,"SELECT * FROM movimtot WHERE tipo='E'  LIMIT $limit, $nroLotes ");
