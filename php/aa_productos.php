...
<script src="../js/myjavaProd.js"></script>
...
<center><h4>MODULO DE ARTICULOS</h4></center>
</div> <!-- fin col-sm-2 -->
<div class="col-sm-4 hidden-xs" style="background-color:white;">
    ...
    <div class="modal fade" id="registra-artis" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title" id="myModalLabel"><b>Formulario Articulos</b></h4>
            </div>
     ...
     <div class="row">
         		<div class="col-md-6">
          		...
          		<div class="col-md-3">
                  <span class="help-block text-muted small-font tipe" >  Marca</span>
                  <input type="text" class="form-control input-sm" id="mar" name="mar" placeholder="Marca" />
              	</div>
     ...
     <div class="row">
                  ...
                  <input type="text" class="form-control input-sm" id="stom" name="stom" placeholder="Stock" />
              	</div>
          		
                 <div class="col-md-2">
                  <span class="help-block text-muted small-font tipe" >  U.Med.:</span>
                  <input type="text" class="form-control input-sm" id="ume" name="ume" placeholder="U.Medida" />
              	</div>
       			<div class="col-md-2">
                  <span class="help-block text-muted small-font tipe" >  Precio Neto:</span>
                  <input type="text" class="form-control input-sm" id="pnet" name="pnet" placeholder="Precio Neto" />
              	</div>
       			<div class="col-md-2">
                  <span class="help-block text-muted small-font tipe" >  Precio c/Iva:</span>
                  <input type="text" class="form-control input-sm" id="pci" name="pci" placeholder="Precio c/Iva" />
              	</div>              	              	
          		<div class="col-md-2">
                  <span class="help-block text-muted small-font tipe" >  Precio s/Iva:</span>
                  <input type="text" class="form-control input-sm" id="psi" name="psi" placeholder="Precio s/Iva" />
              	</div>
          		<div class="col-md-2">
                  <span class="help-block text-muted small-font tipe" >  Precio Mayor:</span>
                  <input type="text" class="form-control input-sm" id="pmay" name="pmay" placeholder="Precio Mayor" />
              	</div>
      	...
      	<div class="row">
          		...
          		<div class="col-md-6">
                  <span class="help-block text-muted small-font tipe" >  Compatibilidad:</span>
                  <input type="text" class="form-control input-sm" id="compa" name="compa" placeholder="Compatibilidad" />
              	</div>
