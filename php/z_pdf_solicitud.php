...
$html .= '<td align="center" class="profo">SOLICITUD </td><td align="center"  width="40%">Software<br>Activos</td></tr>';
$html .= '</table>';
...
$html .= '<tr><th>Nro</th><th>&nbsp;Nombre&nbsp;</th><th>Direccion</th><th>Telf/Cel.</th><th>E-mail</th></tr>';
$it=0;
$row = mysqli_query($conexion,"SELECT * FROM abastedet ORDER BY nordenaba ASC");
while ($row2 = mysqli_fetch_array($row)) {
$it=$it+1;
//$fechh= date("d-m-Y", strtotime($row2['fecha_nac']) );
$html .= '<tr ><td WIDTH="3%" align="center">'.$it.'</td><td WIDTH="15%" align="left">'.$row2['detalle'].'</td><td WIDTH="15%" align="left">'.$row2['cant'].'</td>
<td WIDTH="7%" align="left">'.$row2['umed'].'</td><td WIDTH="10%" align="left">'.$row2['nordenaba'].'</td>';
