...
-->
		...
		<!-- java personal -->
        <script src="../js_raos/myjavaEtiq.js"></script>
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS ///////////////////////////////////////////////////////////// -->
											...
											<button class="btn btn-white btn-info btn-bold" id="expoPdf2">
												<i class="ace-icon fa fa-file-pdf-o bigger-50 red"></i>
												PDF ETIQUETAS
											</button>
	...
	<div class="row">
         		<div class="col-md-8">
                  <span class="help-block text-muted small-font tipe" > Centro de Costos:</span>
				  				<select id="lb1" name="lb1" class="form-control lb" require >
                                    <?php
                                        echo '<option selected="selected" disabled="disabled"></option>';
                                        foreach($costosx as $nn): 
                                            echo '<option value="'.$nn['codcc'].'">'.$nn['detcostos']."/".$nn['codcciso'].'</option>';
                                        endforeach;
                                    ?>
                                </select>  
              	</div>
...
<div class="row">
         		...
         		<div class="col-md-8">
                  ...
                  <input type="text" class="form-control input-sm" id="codauto" name="codauto" placeholder="Codigo" require />
              	</div>
...
<div class="row">
         		...
         		<div class="col-md-12">
                  ...
                  <input type="text" require class="form-control input-sm" id="det" name="det"  placeholder="Detalle"/>
              	</div>
</div>
<div class="row">
...
<div class="row">
         		...
         		<div class="col-md-4">
                  <span class="help-block text-muted small-font tipe" >Codigo Antig: </span>
                  <input type="text" class="form-control input-sm" id="codant" name="codant" placeholder="Codigo Antig." />
              	</div>
</div>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
			    ...
			    <div class="form-group">
                    ...
                    <div class="col-xs-10">
        			<input type="text" class="form-control" id="nomrep" name="nomrep" required placeholder="Repuesto ">
                    </div>
    			</div>
			    <div class="form-group">
			    ...
			    <div class="form-group">
        			<label class="control-label col-xs-2 titi" for="salcr">Codigo Antig:</label>
                    <div class="col-xs-6">
        			<input type="text" class="form-control" id="codigoan" name="codigoan"  placeholder="Codigo Antig.">
                    </div>
    			</div>
