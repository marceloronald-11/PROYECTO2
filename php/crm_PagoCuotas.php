...
-->
		...
		<!-- java personal -->
        <script src="../js_raos/myjavaCuotasPago.js"></script>
						...
						<div class="nav-search" id="nav-search">
							<form class="form-search">
								<span class="input-icon">
									<input type="text" placeholder="Buscar ..." class="navv-search-input bs-prod" id="nav-search-inputt" autocomplete="off" />
									<i class="ace-iconxx fa fa-search nav-search-icon "></i>
								</span>
							</form>
						</div><!-- /.nav-search -->
					</div>
...
-->
    ...
    <div class="modal fade" id="modal-pagar" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
              <h4 class="modal-title" id="myModalLabel"><b>FORM.PAGOS</b></h4>
            </div>
            <form id="formulario" class="form-horizontal " onsubmit="return agregaRegistroCuota();">
            <div class="modal-body">
			    ...
			    <div class="form-group">
        			<label class="control-label col-xs-3 titi" for="fesoli">Fecha :</label>
                    <div class="col-xs-4">

        			<input type="date" class="form-control" id="fesoli" name="fesoli" required >
                    </div>
    			</div>
				
			    <div class="form-group">
        			<label class="control-label col-xs-3 titi" for="mtto">Importe Total:</label>
                    <div class="col-xs-4">
        			<input type="text" class="form-control" id="mtto" name="mtto" required placeholder="Importe Total ">
                    </div>
    			</div>
				...
				<div class="col-xs-9">
				<textarea class="form-control" rows="3" id="observpg" required name="observpg" placeholder="Observaciones"></textarea>
				</div>
				</div>                

			    <!--<div class="form-group">
        			<label class="control-label col-xs-3 titi" for="ncuota">No Cuotas :</label>
                    <div class="col-xs-4">
        			<input type="text" class="form-control" id="ncuota" name="ncuota" required placeholder="No Cuotas ">
                    </div>
    			</div>-->
            ...
            <div class="modal-footer">
                ...
                <input type="submit" value="Pagar Cuota" class="btn btn-warning"  id="edi"/>
