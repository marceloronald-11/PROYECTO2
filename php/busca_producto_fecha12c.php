...
$registro= mysql_query("SELECT * FROM productos INNER JOIN venta_detalle ON productos.id_prod = venta_detalle.idproducto INNER JOIN venta ON venta.id=venta_detalle.idventa WHERE fecha BETWEEN '$desde' AND '$hasta' AND venta.tmov='I' ");	
