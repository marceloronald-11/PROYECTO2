...
<script src="../js/myjavaprovee.js"></script>
...
<center><h3>PROVEEDOR REGISTRO</h3></center>
</div> <!-- fin col-sm-2 -->
<div class="col-sm-4" style="background-color:white;">
...
<div class="col-sm-10" style="background-color:white;">
    ...
    <div class="input-group col-xs-6">
     <input type="text" class="form-control" placeholder="Buscar Proveedor" id="bs-prod" >
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title" id="myModalLabel"><b>Formulario Proveedor</b></h4>
            </div>
            ...
            <div class="modal-body">
			    ...
			    <div class="form-group">
        			<label class="control-label col-xs-3 titi" for="nomb">Nombre:</label>
                    <div class="col-xs-9">
			    ...
			    <div class="form-group">
        			<label class="control-label col-xs-3 titi" for="direc">Direccion:</label>
                    <div class="col-xs-9">
        			<input type="text" class="form-control" id="direcc" name="direcc" required placeholder="Direccion">
                    </div>
    			</div>
			    <div class="form-group">
			    ...
			    <div class="form-group">
        			<label class="control-label col-xs-3 titi" for="email">E-mail:</label>
                    <div class="col-xs-7">
        			<input type="email" class="form-control" id="email" name="email" required placeholder="Email">
                    </div>
    			</div>
			    <div class="form-group">
        			<label class="control-label col-xs-3 titi" for="ci">No Carnet:</label>
                    <div class="col-xs-7">
