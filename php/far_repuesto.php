...
-->
		...
		<!-- java personal -->
        <!-- <script src="../js_raos/myjavaClasi.js"></script> -->
        <script src="../js_raos/j_myjavaCaja.js"></script>
...
<form id="formulario" class="form-horizontal " onsubmit="return agregaRegistro();">
            <div class="modal-body">
					...
					<input type="text"  id="ccosto1" name="ccosto1" />
					<input type="text"  id="procc1" name="procc1" />
					<input type="text"  id="maqq1" name="maqq1" />
					<input type="text"  id="ele1" name="ele1" />
						...
						<div class="form-group">
                                <label class="control-label col-xs-3 titi" for="codaut">Codigo Generado:</label>
                                <div class="col-xs-9 col-sm-5 col-lg-5">
                                <input type="text" class="form-control" id="codauto" name="codauto" required placeholder="Codigo">
                                </div>
                            </div>
    ...
    <div class="modal fade" id="labo-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <form id="formulario" class="form-horizontal " onsubmit="return agregaRegistrocla();">
            <div class="modal-body">
			    ...
			    <div class="form-group">
        			<label class="control-label col-xs-3 titi" for="nomcla">Clasificacion :</label>
                    <div class="col-xs-9">
        			<input type="text" class="form-control" id="nomcla" name="nomcla" required placeholder="Clasificacion ">
                    </div>
    			</div>
