...
$norden = $_GET['norden'];
$brow = mysqli_query($conexion,"SELECT * FROM movimtot  WHERE norden='$norden'");
while ($bb = mysqli_fetch_array($brow)) {
	$xarea=$bb['tmm'];
}
...
switch ($Tituloo) {
    case "Inventario":
        $mititulo='COMPRAS INVENTARIO';
        break;
    case "Orden":
        $mititulo='ORDEN DE COMPRAS';
        break;
    case "Personal":
        $mititulo='ORDEN ENTREGA PERSONAL';
        break;
    case "PersonalDv":
        $mititulo='DEVOLUCION DEL PERSONAL';
        break;
    case "Transferencia":
        $mititulo='ORDEN DE TRANSFERENCIA';
        break;
...
$html .= '<tr><td align="center" class="lfactura">'.$mititulo.'</td></tr>';
