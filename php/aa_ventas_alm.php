...
$paimprimir = $objProducto->getImprimirVta();
...
<script src="../js/myjavaSucu1.js"></script>
        ...
        <div class="panel-body">
            ...
            <input type="hidden" readonly id="codclixx" name="codclixx" >
            	     ...
            	     <div class="row">
              			...
              			<div class="col-md-4">
                  		<span class="help-block text-muted small-font" > Tipo Venta</span>
...
-->                                </select>
        ...
        <div class="panel-footer"><button type="button" class="btn btn-success guardar-entrada2" accesskey="g"> <span class="glyphicon glyphicon-save"></span> <u>G</u>rabar Nota</button>
...
<div class="row-fluid"><!-- row bb --> 
 <div class="panel-group coli3">
    <div class="panel panel-info">
      <div class="panel-heading">
        <h4 class="panel-title">
          <a data-toggle="collapse" href="#collapse3">IMPRESION ORDENES DE VENTA</a>
        </h4>
      </div>
	...
	<td align="center" width="5%"><a href="javascript:mostrarVenta(<?php echo $dett2['norden']; ?>)"><img src="../recursos/impresora.png" data-toggle="tooltip" title="Impresion de Nota"></a></td>                               
					        </tr>
					        <?php }?>
					    </tbody>
					</table>
