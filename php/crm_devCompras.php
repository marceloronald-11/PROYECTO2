...
-->
		...
		<!-- java personal -->
        <script src="../js_raos/myjavadevcompra.js"></script>
...
?>
	...
	<body class="no-skin">
		<div id="navbar" class="navbar navbar-default cabeza ace-save-state">
			<div class="navbar-container ace-save-state" id="navbar-container">
				...
				<div class="navbar-header pull-left">
					<a href="../index.html" class="navbar-brand">
						<small>
							<img src="../recursos/jachalogo.png" height="30px" width="30px" class="" alt="Jacha Inti" />
							 FARMACIA OJEDA
						</small>
					</a>
				</div>
...
-->
	...
	<form class="form-search">
								<!--<span class="input-icon">-->
									<!--<input type="date"  class="nav-search-input fei" id="nav-search-input" /> <input type="date"  class="nav-search-input fef" id="nav-search-input" />--><hr>
									<!--<i class="ace-icon fa fa-search nav-search-icon"></i>-->
								<!--</span>-->
	</form>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title" id="myModalLabel"><b>FORM.DEVOLUCION</b></h4>
            </div>
            <form id="formulario" class="form-horizontal " onsubmit="return agregaRegistroCli();">
            <div class="modal-body">
					 <input type="hidden"   id="codarx" name="codarx" value="0"/>
					 <input type="hidden"   id="nlotex" name="nlotex" value="0"/>
					 <input type="hidden"   id="coddtx" name="coddtx" value="0"/>
					 <input type="hidden"   id="nordenx" name="nordenx" value="0"/>
				
                   	<input type="hidden" required readonly id="pro" name="pro"/>


			    <div class="form-group">
        			<label class="control-label col-xs-3 titi" for="artix">Articulo Completo :</label>
                    <div class="col-xs-9">
        			<input type="text" class="form-control" id="artix" name="artix" required placeholder="Articulo ">
                    </div>
    			</div>
			    <div class="form-group">
        			<label class="control-label col-xs-3 titi" for="cantx">Cantidad:</label>
                    <div class="col-xs-9">
        			<input type="text" class="form-control" id="cantx" name="cantx" required placeholder="Cantidad ">
                    </div>
    			</div>
            ...
            <div class="modal-footer">
                ...
                <input type="submit" value="Procesar Devolucion" class="btn btn-warning"  id="edi"/>
