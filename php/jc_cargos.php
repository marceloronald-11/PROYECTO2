...
-->
		...
		<!-- java personal -->
        <script src="../js_raos/myjavaCargo.js"></script>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title" id="myModalLabel"><b>CARGOS FORM.</b></h4>
            </div>
            ...
            <div class="modal-body">
			    ...
			    <div class="form-group">
        			<label class="control-label col-xs-3 titi" for="nomcar">Detalle :</label>
                    <div class="col-xs-9">
        			<input type="text" class="form-control" id="nomcar" name="nomcar" required placeholder="Detalle ">
                    </div>
    			</div>
