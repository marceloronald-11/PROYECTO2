...
-->
		...
		<!-- java personal -->
        <script src="../js_raos/myjavaUsus.js"></script>
				...
				<div class="main-content-inner">
						...
						<div class="nav-search" id="nav-search">
							<form class="form-search">
								<!--<span class="input-icon">
									<input type="text" placeholder="Buscar ..." class="nav-search-input" id="nav-search-inputxx" autocomplete="off" />
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS ///////////////////////////////////////////////////////////// -->
											<button class="btn btn-white btn-info btn-bold" id="nuevo-usuario">
            ...
            <div class="modal-body">
                ...
                <div class="col-xs-7" >
                    ...
                    <option value="0">Ninguno</option>
						...
						<option value="<?php echo $per['codper']?>"><?php echo $per['nombreper']?></option>
						<?php endforeach;?>
					</select>
                ...
                <div class="col-xs-5" >
					<select name="tiu" id="tiu" class="form-control" >
            			...
            			<option value="usua">Usuario</option>
