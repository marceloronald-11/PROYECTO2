...
<div class="container">
      ...
      <br>
        ...
        <br>
        <br>
        <img src="../recursos/store1.jpg" class="img-responsive">
                    ...
                    $.ajax({
                        ...
                        success:function(data){
                            ...
                            var Datos = {
                                    ...
                                    datasets : [
                                        {
                                            fillColor : 'rgba(100,228,146,0.6)', //COLOR DE LAS BARRAS
