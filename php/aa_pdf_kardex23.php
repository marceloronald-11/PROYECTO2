		...
		<tr>
			<?php
				if($registro2['fechadt']>="$desde" AND $registro2['fechadt']<="$hasta" ){ ?>
							<td align="center" class="bor"><?php echo $fdia; ?></td>
							<td align="center" class="bor"><?php echo $registro2['norden']; ?></td>
							<td class="bor"><?php echo $registro2['afavor']; ?></td>
							<td align="center" class="bor"><?php echo $registro2['tmm']; ?></td>
			<?php } ?>
<?php							
if($registro2['tipo']=='I'){
	$ti+=$registro2['cant'];
	...
	if($registro2['fechadt']>="$desde" AND $registro2['fechadt']<="$hasta" ){
	?>	
	<td WIDTH="9%" align="center" class="bor"><?php echo number_format($registro2['cant'],0); ?></td>
	<td WIDTH="9%" align="center" class="bor"><?php echo number_format($costouu,2); ?></td>
		<?php $cosi=$costouu*$registro2['cant']; ?>
	<td WIDTH="9%" align="right" class="bor"><?php echo number_format($cosi,2); ?></td>
		
	<td WIDTH="9%" align="center" class="bor"></td>
	<td WIDTH="9%" align="center" class="bor"></td>
	<td WIDTH="9%" align="center" class="bor"></td>
	<?php }
}else{
	...
	<td WIDTH="9%" align="right" class="bor"><?php echo number_format($totsal,2); ?></td>		
<?php		
	}
}							
if($registro2['fechadt']>="$desde" AND $registro2['fechadt']<="$hasta" ){ ?>
	<td WIDTH="5%" align="center" class="bor"><?php echo number_format($saldoa,0); ?></td>'
<?php }
	if($tix=='I'){ ?>
	<td WIDTH="5%" align="center" class="bor"><?php echo number_format($costouu,2); ?></td>
	<?php $cosi=$costouu*$saldoa; ?>
	<td WIDTH="9%" align="center" class="bor"><?php echo number_format($cosi,2); ?></td>
	<?php	
	}else{
	?>	
		<td WIDTH="9%" align="center" class="bor"><?php echo number_format($costouu,2); ?></td>
