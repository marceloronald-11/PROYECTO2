...
<html lang="en">
	<head>
       ...
       <!-- <script src="../js/script/jquery-3.3.1.min.js"></script>  -->      
        ...
        <script src="../js_raos/myjavaServi2.js"></script>
<!-- Alertyfy -->
...
<div class="col-sm-6" style="background-color:white;"> 
 <div class="panel-group coli3">
    <div class="panel panel-primary">
      <div class="panel-heading">
        <h4 class="panel-title">
          <a data-toggle="collapse" href="#collapse4">DATOS DEL CLIENTE</a>
        </h4>
      </div>
  ...
  <div class="form-row">
    <div class="form-group col-md-6">
      <label for="inputEmail4">No Carnet</label>
      <input type="text" readonly class="form-control" id="ci" onKeyPress="return solonumeros(event);" placeholder="No Carnet">
    </div>
 ...
 <div class="form-row">
    <div class="form-group col-md-6">
      <label for="coservi">Servicios :</label>
      <select name="coservi" id="coservi" class="form-control" >
 <option value="0">Ninguno</option>
	<?php foreach($servi as $dato1):?>
<option value="<?php echo $dato1['codser']?>"><?php echo $dato1['detservicio']?></option>
	<?php endforeach;?>
	</select>
  ...
  <button type="button" class="btn btn-primary btn-agregar-service" accesskey="a"><span class="glyphicon glyphicon-plus-sign"></span> <u>A</u>gregar Servicio</button>
...
<div class="col-sm-6" style="background-color:white;"> 
  <div class="panel-group coli3">
    <div class="panel panel-success">
      <div class="panel-heading">
        <h4 class="panel-title">
          <a data-toggle="collapse" href="#collapse1"> SERVICIOS</a>
        </h4>
      </div>
      ...
      <div class="panel-body listaservicios">
					<table class="table table-bordered titi" width="100%">
					    ...
					    <tbody>
					    	<?php 
							$dt='';
					    	foreach($tuservi as $dett2){ 
							$fexx= date("d-m-Y", strtotime($dett2['solicito']) );
							$apro=$dett2['aprobo'];
							if($apro=='P'){$dt='PENDIENTE';}else{$dt='HABILITADO';}	
								
					    	?>
					        <tr>
					        	<td width="15%" align="left"><?php echo $dett2['detservicio'];?></td>
					        	<td width="20%" align="center"><?php echo $fexx;?></td>
					        	<td width="7%" align="center"><?php echo $dt;?></td>

	<td align="center" width="5%"><a href="javascript:ElininaServicio(<?php echo $dett2['codsc']; ?>)"><img src="../recursos/borrar.png" data-toggle="tooltip" title="Eliminar Servicio"></a></td>                               
					        </tr>
					        <?php }?>
					    </tbody>
					</table>
