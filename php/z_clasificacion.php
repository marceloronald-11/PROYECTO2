...
<script src="../js/myjavacla.js"></script>
...
<center><h3>MODULO: CLASIFICACION</h3></center>
</div> <!-- fin col-sm-2 -->
<div class="col-sm-4" style="background-color:white;">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
			    ...
			    <div class="form-group">
        			<label class="control-label col-xs-3 titi" for="nomb">Clasificacion:</label>
                    <div class="col-xs-9">
        			<input type="text" class="form-control" id="nomb" name="nomb" required placeholder="Clasificacion ">
                    </div>
    			</div>
