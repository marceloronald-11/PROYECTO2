<?php
    ...
    $nroProductos = mysqli_num_rows(mysqli_query($conexion,"SELECT * FROM maquina "));
    $nroLotes = 10;
    ...
    if($paginaActual < $nroPaginas){
  	...
  	$registro = mysqli_query($conexion,"SELECT * FROM maquina  LIMIT $limit, $nroLotes ");
	...
	while($registro2 = mysqli_fetch_array($registro)){
		...
		<td align="center"><a href="javascript:eliminaMaq('.$registro2['codmq'].');" ><img src="../recursos/borrar.png" data-toggle="tooltip" title="Eliminar Registro"></a> <a href="javascript:editarMaq('.$registro2['codmq'].');" ><img src="../recursos/lapiz.png" data-toggle="tooltip" title="Editar Registro"></a>
		</td>
						  </tr>';		
	}
