...
-->
		...
		<!-- java personal -->
        <script src="../js_raos/myjavacoa_prod.js"></script>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
					 <input type="hidden"   id="idper" name="idper" />
                   	...
                   	<input type="hidden" value="0" required readonly id="ccar" name="ccar"/>
                   	<input type="hidden" value="0" required readonly id="aar" name="aar"/>
