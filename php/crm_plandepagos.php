...
$codsolix = $_POST['id'];//codsoli
$codclix = $_POST['codclix'];

$_SESSION['codclises']=$codclix;
$_SESSION['codsolises']=$codsolix;
...
<div class="container">
  ...
  <form class="form-inline" id="formularioPlan" onsubmit="return agregaRegPlan();">
	  ...
	  <input type="hidden"  id="codclixx"  name="codclixx" value="<?php echo $codclix;?>" >
	  <input type="hidden"  id="codsolixx"  name="codsolixx" value="<?php echo $codsolix;?>" >	  
    ...
    <div class="form-group">
      <label class="sr-only" for="capitalx">Capital:</label>
      <input type="text" class="form-control col-xs-1" id="capitalx" placeholder="Capital"  name="capitalx">
    </div>
    <div class="form-group">
...
$registro = mysqli_query($conexion,"SELECT * FROM planpagos AS pla LEFT JOIN clientes AS cli ON pla.codcli=cli.codcli WHERE pla.codcli='$codclix' AND pla.codsoli='$codsolix' ");
