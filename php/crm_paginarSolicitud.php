<?php
	...
	while($registro2 = mysqli_fetch_array($registro)){
		...
		$tabla = $tabla.'<tr>
							...
							<td align="center"><a href="javascript:VerSoli('.$registro2['codcli'].');" ><img src="../recursos/buscar3.png" data-toggle="tooltip" title="Ver solicitudes"></a>  <a href="javascript:DatSoliNueva('.$registro2['codcli'].');" ><img src="../recursos/anadir.png" data-toggle="tooltip" title="CREAR NUEVA SOLICITUD"></a>  </td> 
						  </tr>';		
	}
