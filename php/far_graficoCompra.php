...
$(function () {
    $('#container').highcharts({
        ...
        title: {
            text: 'Ranking Consumo 2019'
        },
        subtitle: {
            text: 'Software Web 2019'
        },
        xAxis: {
            categories: [
<?php
...
?>
        ...
        legend: {
            ...
            floating: false,
            borderWidth: 1,
            backgroundColor: ((Highcharts.theme && Highcharts.theme.legendBackgroundColor) || '#e9f29d'),
            shadow: true
        },
        credits: {
            enabled: false
...
<script src="../js/Highcharts-4.1.5/js/export-data.js"></script>
...
<br><br>
<center><a href="far_inicio1.php">Menu Principal</a></center>
	</body>
</html>
