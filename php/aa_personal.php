...
<script src="../js/myjavaPer.js"></script>
...
<center><h4>MODULO DE PERSONAL</h4></center>
</div> <!-- fin col-sm-2 -->
<div class="col-sm-4 hidden-xs" style="background-color:white;">
...
<div class="registros table-responsive" id="agrega-registros" style="width:100%;"></div>
    ...
    <div class="modal fade" id="registra-artis" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title" id="myModalLabel"><b>Registro/Edicion Personal</b></h4>
            </div>
            <form id="formulario" class="form-horizontal " onsubmit="return agregaRegistroPee();">
     ...
     <div class="row">
         		<div class="col-md-4">
                  <span class="help-block text-muted small-font tipe" > Nombre:</span>
                  <input type="text" class="form-control input-sm" name="despv" id="despv" placeholder="Nombre"   />
              	</div>
         		<div class="col-md-4">
