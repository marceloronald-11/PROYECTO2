<?php
    ...
    $nroProductos = mysqli_num_rows(mysqli_query($conexion,"SELECT * FROM movimtot AS mv LEFT JOIN sucursal AS su ON mv.codsuc=su.codsuc  WHERE mv.tipo='E'"));
    $nroLotes = 10;
    ...
    if($paginaActual < $nroPaginas){
  	...
  	$registro = mysqli_query($conexion,"SELECT * FROM movimtot AS mv LEFT JOIN sucursal AS su ON mv.codsuc=su.codsuc  WHERE mv.tipo='E' LIMIT $limit, $nroLotes ");
