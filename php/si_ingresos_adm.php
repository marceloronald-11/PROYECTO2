...
<script src="../js/myjavaIngreso.js"></script>
...
<div class="col-sm-4 hidden-xs" style="background-color:white;"> 
        <table class="table"><tr><td align="left"><img src="../recursos/logo1.png" class="img-responsive" width="100px" height="30px" alt="raos"></td>
        </tr></table>
 </div> 
<!-- fin col-sm-2 -->
<div class="col-sm-4 tit" style="background-color:white;">
<center><h3>ORDEN DE PAGO PROVEEDOR</h3></center>
</div> <!-- fin col-sm-2 -->
<div class="col-sm-4 hidden-xs" style="background-color:white;">
...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="a_articulo.php">Menu</a>
    </div>
    ...
    <div class="panel panel-primary">
      <div class="panel-heading">
        <h4 class="panel-title">
          <a data-toggle="collapse" href="#collapse4">DETALLE DE PAGO</a>
        </h4>
      </div>
...
-->             
 <input type="hidden" class="form-control" id="idconx" />

     			<div class="row">

         			<div class="col-md-4">
                  	<span class="help-block text-muted small-font" >  No Orden Contrato:</span>
                 	 <input type="text" class="form-control input-md coli2" id="nordenbb"  placeholder="No Orden"/>
              		</div>
         			...
         			<div class="col-md-4">
             	     ...
             	     <div class="row">
                  		...
                  		<input type="date" class="form-control input-md coli2" id="feor" value="<?php echo $fecha;?>" placeholder="Fecha" />
              			</div>

               			<div class="col-md-4">
                  		<span class="help-block text-muted small-font" > Factura No</span>
                  		<input type="text" class="form-control input-md coli2"  id="nfa" placeholder="No Factura" />
              			</div>

                        <div class="col-md-4">
                        <span class="help-block text-muted small-font" >  Recibo No:</span>
                         <input type="text" class="form-control input-md coli2" id="nre"   placeholder="No Recibo"   />
                        </div>
					</div>
     			...
     			<div class="row">
         			...
         			<div class="col-md-8">
                 	 ...
                 	 <input type="text" class="form-control input-md coli2" id="concep"  placeholder="Concepto"   />
              		</div>


         			<div class="col-md-3">
                  	<span class="help-block text-muted small-font" >  Importe:</span>
                 	 <input type="text" class="form-control input-md coli2" id="impo"  placeholder="Importe"   />
              		</div>
...
<div class="col-sm-6" style="background-color:white;"> 
  <div class="panel-group coli3">
    <div class="panel panel-success">
      <div class="panel-heading">
        <h4 class="panel-title">
          <a data-toggle="collapse" href="#collapse1"> ORDEN DE PAGO</a>
        </h4>
      </div>
      <div id="collapse1" class="panel-collapse collapse in">
        <div class="panel-body">
            ...
            <input type="hidden" readonly id="idusu" name="idusu" value="<?php echo $id_usu;?>">
            	     ...
            	     <div class="row">
              			...
              			<div class="col-md-4">
                  		<span class="help-block text-muted small-font" > Nro</span>
                  		<input type="text" class="form-control input-sm coli2" readonly id="nnota" value="<?php echo $nroing;?>" placeholder="Nota" />
              			</div>
            	     ...
            	     <div class="row">
                  		...
                  		<input type="text" class="form-control input-sm coli2" id="nomcli" placeholder="Proveedor" />
              			</div>

              			<div class="col-md-4">
                  		<span class="help-block text-muted small-font" > Forma Pago</span>
                                <select name="fpg" id="fpg" class="form-control" >
              			...
              			<div class="col-md-4">
                  		<span class="help-block text-muted small-font" > No Doc.</span>
                  		<input type="text" class="form-control input-sm coli2" id="ndoc" placeholder="No Doc." />
              			</div>                        
            	     ...
            	     <div class="row">
              			...
              			<div class="col-md-4">
                  		<span class="help-block text-muted small-font" > Tipo Servicio</span>
                  		<input type="text" class="form-control input-sm coli2" id="tser" placeholder="Tipo Servicio" />
              			</div>                        
        ...
        <div class="panel-footer"><button type="button" class="btn btn-success guardar-carrito3" accesskey="g"> <span class="glyphicon glyphicon-save"></span> <u>G</u>rabar Nota</button>
...
<div class="row-fluid"><!-- row bb --> 
 <div class="panel-group coli3">
    <div class="panel panel-info">
      <div class="panel-heading">
        <h4 class="panel-title">
          <a data-toggle="collapse" href="#collapse3">IMPRESION ORDENES DE PAGO</a>
        </h4>
      </div>
        ...
        <div class="panel-body">
					<table class="table titi" width="100%">
					    ...
					    <tbody>
							...
							$fexx= date("d-m-Y", strtotime($dett2['fecham']) );
					    	?>
					        <tr>
					        	<td width="20%" align="center"><?php echo $fexx;?></td>
					        	<td width="7%" align="center"><?php echo $dett2['norden'];?></td>
					            <td width="20%" align="center"><?php echo $dett2['afavor'];?></td>
					        	<td width="15%" align="center"><?php echo $dett2['respon'];?></td>
					        	<td width="10%" align="center"><?php echo $dett2['tservicio'];?></td>
