...
mysqli_query($conexion,"UPDATE solicitudtot SET tmm='Entregado' WHERE norden = '$nordenx'");
...
$registro = mysqli_query($conexion,"SELECT * FROM solicitudtot AS so LEFT JOIN areas AS ar ON so.codarea=ar.codarea LEFT JOIN cargo AS ca ON so.codcargo=ca.codcargo WHERE so.tmm='Proceso' OR so.tmm='Entregado' ");
...
<td width="5%" align="center">Acciones</td>
    ...
    <td align="center">'.$registro2['tmm'].'</td>';
                  if($op1=='Entregado'){
                      ...
                      echo' <td align="center"><a href="javascript:envia24('.$registro2['norden'].');" ><img src="../recursos/confirm.png" data-toggle="tooltip" title="Confirmar Compra "></a> <a href="javascript:Imprii('.$registro2['norden'].');" ><img src="../recursos/impresora.png" data-toggle="tooltip" title="Imprimir "></a>
                      </td>
                    </tr>';
  }
}
