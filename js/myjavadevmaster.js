...
$(function(){
	...
	$('#bs-prod').on('change',function(){
		...
		var url = '../php/z_busca_master.php';
		$.ajax({
		type:'POST',
		url:url,
		data:'dato='+dato,
...
function eliminarActivo(id,idar,idno,cant){
	var url = '../php/z_elimina_master.php';
	...
	if(pregunta==true){
		...
		url:url,
		//data:'id='+id, //norden
		data:'id='+id+'&idar='+idar+'&idno='+idno+'&cant='+cant,
		success: function(registro){
			$('#agrega-registros').html(registro);
			return false;
		}
...
function pagination(partida){
	var url = '../php/z_paginarMaster.php';
	$.ajax({
		type:'POST',
		url:url,
