...
//		}
		$.ajax({
			url: '../Controller/ControladorVentas.php?page=22',
			type: 'post',
			data: {'idusu':idusu,'respo':respo,'fechav':fechav,'nitv':nitv},
			dataType: 'json',
			success: function(data) {
...
function mostrarCompras(norden){
...
window.open('../php/aa_pdf_boletaCompra.php?norden='+norden, "_blank", "toolbar=yes,scrollbars=yes,resizable=yes,top=70,left=500,width=700,height=600");
