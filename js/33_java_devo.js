...
//							$("#ppvp").val('');
							alertify.success(data.msj);
							$(".detalle-producto").load('../php/22_detalle_perrr.php');
							$('#formulario')[0].reset();
							$( "#descrip" ).focus();
...
//		var dote = $('#dote').val();
		...
		$.ajax({
			url: '../Controller/Controlador.php?page=555',
			type: 'post',
...
window.open('../php/z_pdf_repdevolper.php?norden='+norden, "_blank", "toolbar=yes,scrollbars=yes,resizable=yes,top=70,left=500,width=700,height=600");
