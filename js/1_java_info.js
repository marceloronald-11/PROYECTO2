...
//		var dote = $('#dote').val();
		...
		$.ajax({
			...
			type: 'post',
			data: {'nnota':nnota,'idusu':idusu,'nomcli':nomcli,'fechav':fechav,'coddepx':coddepx,'fac':fac},
			dataType: 'json',
			success: function(data) {
...
window.open('../php/z_pdf_repInventario.php?norden='+norden, "_blank", "toolbar=yes,scrollbars=yes,resizable=yes,top=70,left=500,width=700,height=600");
