...
function agregaRegistroPe(){
	var url = '../php/aa_agrega_Peddd.php';
	$.ajax({
		type:'POST',
		url:url,
		data:$('#formulario').serialize(),
...
function verTra(idu,codsx){
	var partida=1;
	var url = '../php/aa_paginaPedSuc.php';
	$.ajax({
		type:'POST',
		url:url,
		//data:'idu='+idu,
...
function ConfirmTra(codtx,codarx,codsucx,nordx){
	var partida=1;
	var url = '../php/aa_paginarTf33.php';
	$.ajax({
		type:'POST',
		url:url,
		//data:'idu='+idu,
...
function editarPed(nordenx){
	$('#formulario')[0].reset();
	var url = '../php/aa_edita_pe.php';
		$.ajax({
		type:'POST',
		url:url,
...
function pagination(partida){
	...
	var url = '../php/aa_paginaRecibe.php';
